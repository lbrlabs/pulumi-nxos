...
func NewDhcpRelayAddress(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/dhcpRelayAddress:DhcpRelayAddress", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDhcpRelayAddress(ctx *pulumi.Context,
	...
	var resource DhcpRelayAddress
	err := ctx.ReadResource("nxos:index/dhcpRelayAddress:DhcpRelayAddress", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
