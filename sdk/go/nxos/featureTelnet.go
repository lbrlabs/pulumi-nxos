...
func NewFeatureTelnet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/featureTelnet:FeatureTelnet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureTelnet(ctx *pulumi.Context,
	...
	var resource FeatureTelnet
	err := ctx.ReadResource("nxos:index/featureTelnet:FeatureTelnet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
