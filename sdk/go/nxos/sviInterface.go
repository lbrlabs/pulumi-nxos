...
func NewSviInterface(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/sviInterface:SviInterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSviInterface(ctx *pulumi.Context,
	...
	var resource SviInterface
	err := ctx.ReadResource("nxos:index/sviInterface:SviInterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
