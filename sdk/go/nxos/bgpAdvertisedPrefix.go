...
func NewBgpAdvertisedPrefix(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/bgpAdvertisedPrefix:BgpAdvertisedPrefix", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBgpAdvertisedPrefix(ctx *pulumi.Context,
	...
	var resource BgpAdvertisedPrefix
	err := ctx.ReadResource("nxos:index/bgpAdvertisedPrefix:BgpAdvertisedPrefix", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
