...
func NewBgpPeerTemplateMaxPrefix(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/bgpPeerTemplateMaxPrefix:BgpPeerTemplateMaxPrefix", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBgpPeerTemplateMaxPrefix(ctx *pulumi.Context,
	...
	var resource BgpPeerTemplateMaxPrefix
	err := ctx.ReadResource("nxos:index/bgpPeerTemplateMaxPrefix:BgpPeerTemplateMaxPrefix", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
