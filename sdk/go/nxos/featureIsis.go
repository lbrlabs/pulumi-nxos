...
func NewFeatureIsis(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/featureIsis:FeatureIsis", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureIsis(ctx *pulumi.Context,
	...
	var resource FeatureIsis
	err := ctx.ReadResource("nxos:index/featureIsis:FeatureIsis", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
