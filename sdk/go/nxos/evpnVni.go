...
func NewEvpnVni(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/evpnVni:EvpnVni", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEvpnVni(ctx *pulumi.Context,
	...
	var resource EvpnVni
	err := ctx.ReadResource("nxos:index/evpnVni:EvpnVni", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
