...
func NewFeatureEvpn(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/featureEvpn:FeatureEvpn", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureEvpn(ctx *pulumi.Context,
	...
	var resource FeatureEvpn
	err := ctx.ReadResource("nxos:index/featureEvpn:FeatureEvpn", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
