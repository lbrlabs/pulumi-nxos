...
func NewFeatureSsh(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/featureSsh:FeatureSsh", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureSsh(ctx *pulumi.Context,
	...
	var resource FeatureSsh
	err := ctx.ReadResource("nxos:index/featureSsh:FeatureSsh", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
