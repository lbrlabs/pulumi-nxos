...
func NewEthernet(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/ethernet:Ethernet", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEthernet(ctx *pulumi.Context,
	...
	var resource Ethernet
	err := ctx.ReadResource("nxos:index/ethernet:Ethernet", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
