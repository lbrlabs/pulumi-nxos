...
func NewIpv4StaticRoute(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/ipv4StaticRoute:Ipv4StaticRoute", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpv4StaticRoute(ctx *pulumi.Context,
	...
	var resource Ipv4StaticRoute
	err := ctx.ReadResource("nxos:index/ipv4StaticRoute:Ipv4StaticRoute", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
