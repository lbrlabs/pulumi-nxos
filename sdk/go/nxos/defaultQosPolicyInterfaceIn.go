...
func NewDefaultQosPolicyInterfaceIn(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/defaultQosPolicyInterfaceIn:DefaultQosPolicyInterfaceIn", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDefaultQosPolicyInterfaceIn(ctx *pulumi.Context,
	...
	var resource DefaultQosPolicyInterfaceIn
	err := ctx.ReadResource("nxos:index/defaultQosPolicyInterfaceIn:DefaultQosPolicyInterfaceIn", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
