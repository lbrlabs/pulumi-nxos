...
func NewEvpnVniRouteTargetDirection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/evpnVniRouteTargetDirection:EvpnVniRouteTargetDirection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEvpnVniRouteTargetDirection(ctx *pulumi.Context,
	...
	var resource EvpnVniRouteTargetDirection
	err := ctx.ReadResource("nxos:index/evpnVniRouteTargetDirection:EvpnVniRouteTargetDirection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
