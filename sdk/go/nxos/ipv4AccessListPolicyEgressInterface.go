...
func NewIpv4AccessListPolicyEgressInterface(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/ipv4AccessListPolicyEgressInterface:Ipv4AccessListPolicyEgressInterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpv4AccessListPolicyEgressInterface(ctx *pulumi.Context,
	...
	var resource Ipv4AccessListPolicyEgressInterface
	err := ctx.ReadResource("nxos:index/ipv4AccessListPolicyEgressInterface:Ipv4AccessListPolicyEgressInterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
