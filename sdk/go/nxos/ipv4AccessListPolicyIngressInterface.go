...
func NewIpv4AccessListPolicyIngressInterface(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/ipv4AccessListPolicyIngressInterface:Ipv4AccessListPolicyIngressInterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpv4AccessListPolicyIngressInterface(ctx *pulumi.Context,
	...
	var resource Ipv4AccessListPolicyIngressInterface
	err := ctx.ReadResource("nxos:index/ipv4AccessListPolicyIngressInterface:Ipv4AccessListPolicyIngressInterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
