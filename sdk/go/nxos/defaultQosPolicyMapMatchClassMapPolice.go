...
func NewDefaultQosPolicyMapMatchClassMapPolice(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/defaultQosPolicyMapMatchClassMapPolice:DefaultQosPolicyMapMatchClassMapPolice", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDefaultQosPolicyMapMatchClassMapPolice(ctx *pulumi.Context,
	...
	var resource DefaultQosPolicyMapMatchClassMapPolice
	err := ctx.ReadResource("nxos:index/defaultQosPolicyMapMatchClassMapPolice:DefaultQosPolicyMapMatchClassMapPolice", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
