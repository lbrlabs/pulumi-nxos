...
func NewEvpnVniRouteTarget(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/evpnVniRouteTarget:EvpnVniRouteTarget", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetEvpnVniRouteTarget(ctx *pulumi.Context,
	...
	var resource EvpnVniRouteTarget
	err := ctx.ReadResource("nxos:index/evpnVniRouteTarget:EvpnVniRouteTarget", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
