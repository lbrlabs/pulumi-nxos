...
func NewBgpPeer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/bgpPeer:BgpPeer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBgpPeer(ctx *pulumi.Context,
	...
	var resource BgpPeer
	err := ctx.ReadResource("nxos:index/bgpPeer:BgpPeer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
