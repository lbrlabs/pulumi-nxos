...
func NewNveVniContainer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/nveVniContainer:NveVniContainer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNveVniContainer(ctx *pulumi.Context,
	...
	var resource NveVniContainer
	err := ctx.ReadResource("nxos:index/nveVniContainer:NveVniContainer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
