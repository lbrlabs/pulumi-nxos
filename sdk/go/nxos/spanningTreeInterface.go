...
func NewSpanningTreeInterface(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/spanningTreeInterface:SpanningTreeInterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSpanningTreeInterface(ctx *pulumi.Context,
	...
	var resource SpanningTreeInterface
	err := ctx.ReadResource("nxos:index/spanningTreeInterface:SpanningTreeInterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
