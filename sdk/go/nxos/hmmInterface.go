...
func NewHmmInterface(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/hmmInterface:HmmInterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHmmInterface(ctx *pulumi.Context,
	...
	var resource HmmInterface
	err := ctx.ReadResource("nxos:index/hmmInterface:HmmInterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
