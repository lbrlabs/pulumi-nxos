...
func NewNveVniIngressReplication(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/nveVniIngressReplication:NveVniIngressReplication", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNveVniIngressReplication(ctx *pulumi.Context,
	...
	var resource NveVniIngressReplication
	err := ctx.ReadResource("nxos:index/nveVniIngressReplication:NveVniIngressReplication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
