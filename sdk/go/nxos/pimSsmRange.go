...
func NewPimSsmRange(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/pimSsmRange:PimSsmRange", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPimSsmRange(ctx *pulumi.Context,
	...
	var resource PimSsmRange
	err := ctx.ReadResource("nxos:index/pimSsmRange:PimSsmRange", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
