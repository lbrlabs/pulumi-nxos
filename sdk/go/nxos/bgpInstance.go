...
func NewBgpInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/bgpInstance:BgpInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBgpInstance(ctx *pulumi.Context,
	...
	var resource BgpInstance
	err := ctx.ReadResource("nxos:index/bgpInstance:BgpInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
