...
func NewBgpGracefulRestart(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/bgpGracefulRestart:BgpGracefulRestart", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBgpGracefulRestart(ctx *pulumi.Context,
	...
	var resource BgpGracefulRestart
	err := ctx.ReadResource("nxos:index/bgpGracefulRestart:BgpGracefulRestart", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
