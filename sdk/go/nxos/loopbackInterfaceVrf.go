...
func NewLoopbackInterfaceVrf(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/loopbackInterfaceVrf:LoopbackInterfaceVrf", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoopbackInterfaceVrf(ctx *pulumi.Context,
	...
	var resource LoopbackInterfaceVrf
	err := ctx.ReadResource("nxos:index/loopbackInterfaceVrf:LoopbackInterfaceVrf", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
