...
func NewPimAnycastRp(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/pimAnycastRp:PimAnycastRp", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPimAnycastRp(ctx *pulumi.Context,
	...
	var resource PimAnycastRp
	err := ctx.ReadResource("nxos:index/pimAnycastRp:PimAnycastRp", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
