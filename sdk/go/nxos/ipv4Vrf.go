...
func NewIpv4Vrf(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/ipv4Vrf:Ipv4Vrf", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpv4Vrf(ctx *pulumi.Context,
	...
	var resource Ipv4Vrf
	err := ctx.ReadResource("nxos:index/ipv4Vrf:Ipv4Vrf", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
