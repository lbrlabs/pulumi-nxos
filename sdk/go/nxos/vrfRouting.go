...
func NewVrfRouting(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/vrfRouting:VrfRouting", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVrfRouting(ctx *pulumi.Context,
	...
	var resource VrfRouting
	err := ctx.ReadResource("nxos:index/vrfRouting:VrfRouting", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
