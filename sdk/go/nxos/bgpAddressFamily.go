...
func NewBgpAddressFamily(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/bgpAddressFamily:BgpAddressFamily", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBgpAddressFamily(ctx *pulumi.Context,
	...
	var resource BgpAddressFamily
	err := ctx.ReadResource("nxos:index/bgpAddressFamily:BgpAddressFamily", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
