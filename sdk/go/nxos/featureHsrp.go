...
func NewFeatureHsrp(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/featureHsrp:FeatureHsrp", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureHsrp(ctx *pulumi.Context,
	...
	var resource FeatureHsrp
	err := ctx.ReadResource("nxos:index/featureHsrp:FeatureHsrp", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
