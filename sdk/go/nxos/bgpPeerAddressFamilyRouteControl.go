...
func NewBgpPeerAddressFamilyRouteControl(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/bgpPeerAddressFamilyRouteControl:BgpPeerAddressFamilyRouteControl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBgpPeerAddressFamilyRouteControl(ctx *pulumi.Context,
	...
	var resource BgpPeerAddressFamilyRouteControl
	err := ctx.ReadResource("nxos:index/bgpPeerAddressFamilyRouteControl:BgpPeerAddressFamilyRouteControl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
