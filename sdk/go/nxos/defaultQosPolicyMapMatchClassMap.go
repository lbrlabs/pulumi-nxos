...
func NewDefaultQosPolicyMapMatchClassMap(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/defaultQosPolicyMapMatchClassMap:DefaultQosPolicyMapMatchClassMap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDefaultQosPolicyMapMatchClassMap(ctx *pulumi.Context,
	...
	var resource DefaultQosPolicyMapMatchClassMap
	err := ctx.ReadResource("nxos:index/defaultQosPolicyMapMatchClassMap:DefaultQosPolicyMapMatchClassMap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
