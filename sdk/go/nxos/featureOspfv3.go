...
func NewFeatureOspfv3(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/featureOspfv3:FeatureOspfv3", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureOspfv3(ctx *pulumi.Context,
	...
	var resource FeatureOspfv3
	err := ctx.ReadResource("nxos:index/featureOspfv3:FeatureOspfv3", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
