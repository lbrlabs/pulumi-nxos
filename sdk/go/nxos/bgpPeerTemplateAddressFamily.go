...
func NewBgpPeerTemplateAddressFamily(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/bgpPeerTemplateAddressFamily:BgpPeerTemplateAddressFamily", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBgpPeerTemplateAddressFamily(ctx *pulumi.Context,
	...
	var resource BgpPeerTemplateAddressFamily
	err := ctx.ReadResource("nxos:index/bgpPeerTemplateAddressFamily:BgpPeerTemplateAddressFamily", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
