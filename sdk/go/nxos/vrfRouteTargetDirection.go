...
func NewVrfRouteTargetDirection(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/vrfRouteTargetDirection:VrfRouteTargetDirection", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVrfRouteTargetDirection(ctx *pulumi.Context,
	...
	var resource VrfRouteTargetDirection
	err := ctx.ReadResource("nxos:index/vrfRouteTargetDirection:VrfRouteTargetDirection", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
