...
func NewFeatureDhcp(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/featureDhcp:FeatureDhcp", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureDhcp(ctx *pulumi.Context,
	...
	var resource FeatureDhcp
	err := ctx.ReadResource("nxos:index/featureDhcp:FeatureDhcp", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
