...
func NewFeaturePtp(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/featurePtp:FeaturePtp", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeaturePtp(ctx *pulumi.Context,
	...
	var resource FeaturePtp
	err := ctx.ReadResource("nxos:index/featurePtp:FeaturePtp", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
