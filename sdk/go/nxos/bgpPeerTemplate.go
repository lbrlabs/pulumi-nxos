...
func NewBgpPeerTemplate(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/bgpPeerTemplate:BgpPeerTemplate", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBgpPeerTemplate(ctx *pulumi.Context,
	...
	var resource BgpPeerTemplate
	err := ctx.ReadResource("nxos:index/bgpPeerTemplate:BgpPeerTemplate", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
