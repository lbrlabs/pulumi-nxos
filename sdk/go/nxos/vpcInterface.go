...
func NewVpcInterface(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/vpcInterface:VpcInterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpcInterface(ctx *pulumi.Context,
	...
	var resource VpcInterface
	err := ctx.ReadResource("nxos:index/vpcInterface:VpcInterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
