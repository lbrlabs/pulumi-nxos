...
func NewFeatureMacsec(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/featureMacsec:FeatureMacsec", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureMacsec(ctx *pulumi.Context,
	...
	var resource FeatureMacsec
	err := ctx.ReadResource("nxos:index/featureMacsec:FeatureMacsec", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
