...
func NewIpv4AccessListEntry(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/ipv4AccessListEntry:Ipv4AccessListEntry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpv4AccessListEntry(ctx *pulumi.Context,
	...
	var resource Ipv4AccessListEntry
	err := ctx.ReadResource("nxos:index/ipv4AccessListEntry:Ipv4AccessListEntry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
