...
func NewLoopbackInterface(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/loopbackInterface:LoopbackInterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetLoopbackInterface(ctx *pulumi.Context,
	...
	var resource LoopbackInterface
	err := ctx.ReadResource("nxos:nxos/loopbackInterface:LoopbackInterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
