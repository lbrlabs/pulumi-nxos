...
func NewVrfAddressFamily(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/vrfAddressFamily:VrfAddressFamily", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVrfAddressFamily(ctx *pulumi.Context,
	...
	var resource VrfAddressFamily
	err := ctx.ReadResource("nxos:nxos/vrfAddressFamily:VrfAddressFamily", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
