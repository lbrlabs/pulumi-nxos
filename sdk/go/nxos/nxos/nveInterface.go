...
func NewNveInterface(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/nveInterface:NveInterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNveInterface(ctx *pulumi.Context,
	...
	var resource NveInterface
	err := ctx.ReadResource("nxos:nxos/nveInterface:NveInterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
