...
func NewIpv4PrefixListRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/ipv4PrefixListRule:Ipv4PrefixListRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpv4PrefixListRule(ctx *pulumi.Context,
	...
	var resource Ipv4PrefixListRule
	err := ctx.ReadResource("nxos:nxos/ipv4PrefixListRule:Ipv4PrefixListRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
