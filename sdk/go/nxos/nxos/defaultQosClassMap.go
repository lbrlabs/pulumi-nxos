...
func NewDefaultQosClassMap(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/defaultQosClassMap:DefaultQosClassMap", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDefaultQosClassMap(ctx *pulumi.Context,
	...
	var resource DefaultQosClassMap
	err := ctx.ReadResource("nxos:nxos/defaultQosClassMap:DefaultQosClassMap", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
