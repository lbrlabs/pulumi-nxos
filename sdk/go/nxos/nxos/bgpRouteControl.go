...
func NewBgpRouteControl(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/bgpRouteControl:BgpRouteControl", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBgpRouteControl(ctx *pulumi.Context,
	...
	var resource BgpRouteControl
	err := ctx.ReadResource("nxos:nxos/bgpRouteControl:BgpRouteControl", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
