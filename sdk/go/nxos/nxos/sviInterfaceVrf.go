...
func NewSviInterfaceVrf(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/sviInterfaceVrf:SviInterfaceVrf", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSviInterfaceVrf(ctx *pulumi.Context,
	...
	var resource SviInterfaceVrf
	err := ctx.ReadResource("nxos:nxos/sviInterfaceVrf:SviInterfaceVrf", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
