...
func NewPimStaticRp(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/pimStaticRp:PimStaticRp", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPimStaticRp(ctx *pulumi.Context,
	...
	var resource PimStaticRp
	err := ctx.ReadResource("nxos:nxos/pimStaticRp:PimStaticRp", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
