...
func NewPhysicalInterface(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/physicalInterface:PhysicalInterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPhysicalInterface(ctx *pulumi.Context,
	...
	var resource PhysicalInterface
	err := ctx.ReadResource("nxos:nxos/physicalInterface:PhysicalInterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
