...
func NewVpcInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/vpcInstance:VpcInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpcInstance(ctx *pulumi.Context,
	...
	var resource VpcInstance
	err := ctx.ReadResource("nxos:nxos/vpcInstance:VpcInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
