...
func NewHmmInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/hmmInstance:HmmInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetHmmInstance(ctx *pulumi.Context,
	...
	var resource HmmInstance
	err := ctx.ReadResource("nxos:nxos/hmmInstance:HmmInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
