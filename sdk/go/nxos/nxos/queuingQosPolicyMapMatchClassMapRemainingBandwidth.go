...
func NewQueuingQosPolicyMapMatchClassMapRemainingBandwidth(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/queuingQosPolicyMapMatchClassMapRemainingBandwidth:QueuingQosPolicyMapMatchClassMapRemainingBandwidth", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetQueuingQosPolicyMapMatchClassMapRemainingBandwidth(ctx *pulumi.Context,
	...
	var resource QueuingQosPolicyMapMatchClassMapRemainingBandwidth
	err := ctx.ReadResource("nxos:nxos/queuingQosPolicyMapMatchClassMapRemainingBandwidth:QueuingQosPolicyMapMatchClassMapRemainingBandwidth", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
