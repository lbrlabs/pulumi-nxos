...
func NewPortChannelInterfaceVrf(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/portChannelInterfaceVrf:PortChannelInterfaceVrf", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPortChannelInterfaceVrf(ctx *pulumi.Context,
	...
	var resource PortChannelInterfaceVrf
	err := ctx.ReadResource("nxos:nxos/portChannelInterfaceVrf:PortChannelInterfaceVrf", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
