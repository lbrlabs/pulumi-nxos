...
func NewIsisInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/isisInstance:IsisInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIsisInstance(ctx *pulumi.Context,
	...
	var resource IsisInstance
	err := ctx.ReadResource("nxos:nxos/isisInstance:IsisInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
