...
func NewPimStaticRpPolicy(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/pimStaticRpPolicy:PimStaticRpPolicy", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPimStaticRpPolicy(ctx *pulumi.Context,
	...
	var resource PimStaticRpPolicy
	err := ctx.ReadResource("nxos:nxos/pimStaticRpPolicy:PimStaticRpPolicy", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
