...
func NewBridgeDomain(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/bridgeDomain:BridgeDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBridgeDomain(ctx *pulumi.Context,
	...
	var resource BridgeDomain
	err := ctx.ReadResource("nxos:nxos/bridgeDomain:BridgeDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
