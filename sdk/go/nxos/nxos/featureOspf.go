...
func NewFeatureOspf(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/featureOspf:FeatureOspf", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureOspf(ctx *pulumi.Context,
	...
	var resource FeatureOspf
	err := ctx.ReadResource("nxos:nxos/featureOspf:FeatureOspf", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
