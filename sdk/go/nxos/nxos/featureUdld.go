...
func NewFeatureUdld(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/featureUdld:FeatureUdld", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureUdld(ctx *pulumi.Context,
	...
	var resource FeatureUdld
	err := ctx.ReadResource("nxos:nxos/featureUdld:FeatureUdld", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
