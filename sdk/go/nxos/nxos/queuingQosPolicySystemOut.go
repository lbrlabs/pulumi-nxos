...
func NewQueuingQosPolicySystemOut(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/queuingQosPolicySystemOut:QueuingQosPolicySystemOut", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetQueuingQosPolicySystemOut(ctx *pulumi.Context,
	...
	var resource QueuingQosPolicySystemOut
	err := ctx.ReadResource("nxos:nxos/queuingQosPolicySystemOut:QueuingQosPolicySystemOut", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
