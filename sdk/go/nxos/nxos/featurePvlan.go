...
func NewFeaturePvlan(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/featurePvlan:FeaturePvlan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeaturePvlan(ctx *pulumi.Context,
	...
	var resource FeaturePvlan
	err := ctx.ReadResource("nxos:nxos/featurePvlan:FeaturePvlan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
