...
func NewOspfAuthentication(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/ospfAuthentication:OspfAuthentication", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOspfAuthentication(ctx *pulumi.Context,
	...
	var resource OspfAuthentication
	err := ctx.ReadResource("nxos:nxos/ospfAuthentication:OspfAuthentication", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
