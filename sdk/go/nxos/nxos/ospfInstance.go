...
func NewOspfInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/ospfInstance:OspfInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOspfInstance(ctx *pulumi.Context,
	...
	var resource OspfInstance
	err := ctx.ReadResource("nxos:nxos/ospfInstance:OspfInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
