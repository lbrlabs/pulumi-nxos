...
func NewRouteMapRuleEntryMatchRoutePrefixList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/routeMapRuleEntryMatchRoutePrefixList:RouteMapRuleEntryMatchRoutePrefixList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouteMapRuleEntryMatchRoutePrefixList(ctx *pulumi.Context,
	...
	var resource RouteMapRuleEntryMatchRoutePrefixList
	err := ctx.ReadResource("nxos:nxos/routeMapRuleEntryMatchRoutePrefixList:RouteMapRuleEntryMatchRoutePrefixList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
