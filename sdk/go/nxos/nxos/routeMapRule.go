...
func NewRouteMapRule(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/routeMapRule:RouteMapRule", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouteMapRule(ctx *pulumi.Context,
	...
	var resource RouteMapRule
	err := ctx.ReadResource("nxos:nxos/routeMapRule:RouteMapRule", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
