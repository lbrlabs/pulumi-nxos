...
func NewPimStaticRpGroupList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/pimStaticRpGroupList:PimStaticRpGroupList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPimStaticRpGroupList(ctx *pulumi.Context,
	...
	var resource PimStaticRpGroupList
	err := ctx.ReadResource("nxos:nxos/pimStaticRpGroupList:PimStaticRpGroupList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
