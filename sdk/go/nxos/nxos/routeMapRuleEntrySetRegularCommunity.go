...
func NewRouteMapRuleEntrySetRegularCommunity(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/routeMapRuleEntrySetRegularCommunity:RouteMapRuleEntrySetRegularCommunity", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouteMapRuleEntrySetRegularCommunity(ctx *pulumi.Context,
	...
	var resource RouteMapRuleEntrySetRegularCommunity
	err := ctx.ReadResource("nxos:nxos/routeMapRuleEntrySetRegularCommunity:RouteMapRuleEntrySetRegularCommunity", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
