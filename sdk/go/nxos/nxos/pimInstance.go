...
func NewPimInstance(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/pimInstance:PimInstance", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPimInstance(ctx *pulumi.Context,
	...
	var resource PimInstance
	err := ctx.ReadResource("nxos:nxos/pimInstance:PimInstance", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
