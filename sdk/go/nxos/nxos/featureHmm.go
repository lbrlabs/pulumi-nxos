...
func NewFeatureHmm(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/featureHmm:FeatureHmm", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureHmm(ctx *pulumi.Context,
	...
	var resource FeatureHmm
	err := ctx.ReadResource("nxos:nxos/featureHmm:FeatureHmm", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
