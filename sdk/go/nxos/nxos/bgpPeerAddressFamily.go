...
func NewBgpPeerAddressFamily(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/bgpPeerAddressFamily:BgpPeerAddressFamily", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetBgpPeerAddressFamily(ctx *pulumi.Context,
	...
	var resource BgpPeerAddressFamily
	err := ctx.ReadResource("nxos:nxos/bgpPeerAddressFamily:BgpPeerAddressFamily", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
