...
func NewOspfInterface(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/ospfInterface:OspfInterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOspfInterface(ctx *pulumi.Context,
	...
	var resource OspfInterface
	err := ctx.ReadResource("nxos:nxos/ospfInterface:OspfInterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
