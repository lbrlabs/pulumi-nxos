...
func NewIsisInterface(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/isisInterface:IsisInterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIsisInterface(ctx *pulumi.Context,
	...
	var resource IsisInterface
	err := ctx.ReadResource("nxos:nxos/isisInterface:IsisInterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
