...
func NewFeatureInterfaceVlan(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/featureInterfaceVlan:FeatureInterfaceVlan", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureInterfaceVlan(ctx *pulumi.Context,
	...
	var resource FeatureInterfaceVlan
	err := ctx.ReadResource("nxos:nxos/featureInterfaceVlan:FeatureInterfaceVlan", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
