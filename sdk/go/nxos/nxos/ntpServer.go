...
func NewNtpServer(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/ntpServer:NtpServer", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNtpServer(ctx *pulumi.Context,
	...
	var resource NtpServer
	err := ctx.ReadResource("nxos:nxos/ntpServer:NtpServer", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
