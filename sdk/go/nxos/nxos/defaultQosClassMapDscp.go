...
func NewDefaultQosClassMapDscp(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/defaultQosClassMapDscp:DefaultQosClassMapDscp", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDefaultQosClassMapDscp(ctx *pulumi.Context,
	...
	var resource DefaultQosClassMapDscp
	err := ctx.ReadResource("nxos:nxos/defaultQosClassMapDscp:DefaultQosClassMapDscp", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
