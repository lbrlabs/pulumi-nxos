...
func NewPimInterface(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/pimInterface:PimInterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPimInterface(ctx *pulumi.Context,
	...
	var resource PimInterface
	err := ctx.ReadResource("nxos:nxos/pimInterface:PimInterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
