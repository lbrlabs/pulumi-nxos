...
func NewIpv4InterfaceAddress(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/ipv4InterfaceAddress:Ipv4InterfaceAddress", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpv4InterfaceAddress(ctx *pulumi.Context,
	...
	var resource Ipv4InterfaceAddress
	err := ctx.ReadResource("nxos:nxos/ipv4InterfaceAddress:Ipv4InterfaceAddress", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
