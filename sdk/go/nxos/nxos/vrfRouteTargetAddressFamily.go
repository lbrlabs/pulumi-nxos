...
func NewVrfRouteTargetAddressFamily(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/vrfRouteTargetAddressFamily:VrfRouteTargetAddressFamily", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVrfRouteTargetAddressFamily(ctx *pulumi.Context,
	...
	var resource VrfRouteTargetAddressFamily
	err := ctx.ReadResource("nxos:nxos/vrfRouteTargetAddressFamily:VrfRouteTargetAddressFamily", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
