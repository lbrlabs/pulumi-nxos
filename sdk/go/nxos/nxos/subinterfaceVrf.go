...
func NewSubinterfaceVrf(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/subinterfaceVrf:SubinterfaceVrf", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubinterfaceVrf(ctx *pulumi.Context,
	...
	var resource SubinterfaceVrf
	err := ctx.ReadResource("nxos:nxos/subinterfaceVrf:SubinterfaceVrf", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
