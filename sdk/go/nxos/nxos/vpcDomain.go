...
func NewVpcDomain(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/vpcDomain:VpcDomain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetVpcDomain(ctx *pulumi.Context,
	...
	var resource VpcDomain
	err := ctx.ReadResource("nxos:nxos/vpcDomain:VpcDomain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
