...
func NewPhysicalInterfaceVrf(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/physicalInterfaceVrf:PhysicalInterfaceVrf", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetPhysicalInterfaceVrf(ctx *pulumi.Context,
	...
	var resource PhysicalInterfaceVrf
	err := ctx.ReadResource("nxos:nxos/physicalInterfaceVrf:PhysicalInterfaceVrf", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
