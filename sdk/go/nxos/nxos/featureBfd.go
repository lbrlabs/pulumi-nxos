...
func NewFeatureBfd(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/featureBfd:FeatureBfd", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureBfd(ctx *pulumi.Context,
	...
	var resource FeatureBfd
	err := ctx.ReadResource("nxos:nxos/featureBfd:FeatureBfd", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
