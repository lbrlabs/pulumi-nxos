...
func NewFeatureNetflow(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/featureNetflow:FeatureNetflow", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureNetflow(ctx *pulumi.Context,
	...
	var resource FeatureNetflow
	err := ctx.ReadResource("nxos:nxos/featureNetflow:FeatureNetflow", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
