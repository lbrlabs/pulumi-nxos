...
func NewIpv4PrefixListRuleEntry(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/ipv4PrefixListRuleEntry:Ipv4PrefixListRuleEntry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpv4PrefixListRuleEntry(ctx *pulumi.Context,
	...
	var resource Ipv4PrefixListRuleEntry
	err := ctx.ReadResource("nxos:nxos/ipv4PrefixListRuleEntry:Ipv4PrefixListRuleEntry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
