...
func NewFeatureLacp(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/featureLacp:FeatureLacp", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureLacp(ctx *pulumi.Context,
	...
	var resource FeatureLacp
	err := ctx.ReadResource("nxos:nxos/featureLacp:FeatureLacp", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
