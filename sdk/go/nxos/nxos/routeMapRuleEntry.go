...
func NewRouteMapRuleEntry(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/routeMapRuleEntry:RouteMapRuleEntry", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouteMapRuleEntry(ctx *pulumi.Context,
	...
	var resource RouteMapRuleEntry
	err := ctx.ReadResource("nxos:nxos/routeMapRuleEntry:RouteMapRuleEntry", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
