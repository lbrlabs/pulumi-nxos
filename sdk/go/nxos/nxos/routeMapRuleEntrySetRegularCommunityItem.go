...
func NewRouteMapRuleEntrySetRegularCommunityItem(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/routeMapRuleEntrySetRegularCommunityItem:RouteMapRuleEntrySetRegularCommunityItem", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRouteMapRuleEntrySetRegularCommunityItem(ctx *pulumi.Context,
	...
	var resource RouteMapRuleEntrySetRegularCommunityItem
	err := ctx.ReadResource("nxos:nxos/routeMapRuleEntrySetRegularCommunityItem:RouteMapRuleEntrySetRegularCommunityItem", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
