...
func NewFeatureBgp(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:nxos/featureBgp:FeatureBgp", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureBgp(ctx *pulumi.Context,
	...
	var resource FeatureBgp
	err := ctx.ReadResource("nxos:nxos/featureBgp:FeatureBgp", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
