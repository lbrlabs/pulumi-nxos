...
func NewFeatureTacacs(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/featureTacacs:FeatureTacacs", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureTacacs(ctx *pulumi.Context,
	...
	var resource FeatureTacacs
	err := ctx.ReadResource("nxos:index/featureTacacs:FeatureTacacs", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
