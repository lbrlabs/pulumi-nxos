...
func NewSubinterface(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/subinterface:Subinterface", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSubinterface(ctx *pulumi.Context,
	...
	var resource Subinterface
	err := ctx.ReadResource("nxos:index/subinterface:Subinterface", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
