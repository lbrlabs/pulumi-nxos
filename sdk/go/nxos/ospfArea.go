...
func NewOspfArea(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/ospfArea:OspfArea", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetOspfArea(ctx *pulumi.Context,
	...
	var resource OspfArea
	err := ctx.ReadResource("nxos:index/ospfArea:OspfArea", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
