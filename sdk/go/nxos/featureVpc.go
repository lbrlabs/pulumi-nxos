...
func NewFeatureVpc(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/featureVpc:FeatureVpc", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureVpc(ctx *pulumi.Context,
	...
	var resource FeatureVpc
	err := ctx.ReadResource("nxos:index/featureVpc:FeatureVpc", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
