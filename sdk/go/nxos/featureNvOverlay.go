...
func NewFeatureNvOverlay(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/featureNvOverlay:FeatureNvOverlay", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetFeatureNvOverlay(ctx *pulumi.Context,
	...
	var resource FeatureNvOverlay
	err := ctx.ReadResource("nxos:index/featureNvOverlay:FeatureNvOverlay", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
