...
func NewIpv4AccessList(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("nxos:index/ipv4AccessList:Ipv4AccessList", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetIpv4AccessList(ctx *pulumi.Context,
	...
	var resource Ipv4AccessList
	err := ctx.ReadResource("nxos:index/ipv4AccessList:Ipv4AccessList", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
