...
import com.pulumi.nxos.nxos.BgpArgs;
import com.pulumi.nxos.nxos.inputs.BgpState;
import java.lang.String;
import java.util.Optional;
import javax.annotation.Nullable;

@ResourceType(type="nxos:nxos/bgp:Bgp")
public class Bgp extends com.pulumi.resources.CustomResource {
    ...
    public Bgp(String name, @Nullable BgpArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/bgp:Bgp", name, args == null ? BgpArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Bgp(String name, Output<String> id, @Nullable BgpState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/bgp:Bgp", name, state, makeResourceOptions(options, id));
    }
