...
public final class FeatureLacpArgs extends com.pulumi.resources.ResourceArgs {

    public static final FeatureLacpArgs Empty = new FeatureLacpArgs();
    ...
    private FeatureLacpArgs() {}

    private FeatureLacpArgs(FeatureLacpArgs $) {
    ...
    public static Builder builder(FeatureLacpArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FeatureLacpArgs defaults) {
            $ = new FeatureLacpArgs(Objects.requireNonNull(defaults));
        }
