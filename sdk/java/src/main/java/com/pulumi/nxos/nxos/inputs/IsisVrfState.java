...
public final class IsisVrfState extends com.pulumi.resources.ResourceArgs {

    public static final IsisVrfState Empty = new IsisVrfState();
    ...
    private IsisVrfState() {}

    private IsisVrfState(IsisVrfState $) {
    ...
    public static Builder builder(IsisVrfState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(IsisVrfState defaults) {
            $ = new IsisVrfState(Objects.requireNonNull(defaults));
        }
