...
public final class OspfInstanceState extends com.pulumi.resources.ResourceArgs {

    public static final OspfInstanceState Empty = new OspfInstanceState();
    ...
    private OspfInstanceState() {}

    private OspfInstanceState(OspfInstanceState $) {
    ...
    public static Builder builder(OspfInstanceState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OspfInstanceState();
        }

        public Builder(OspfInstanceState defaults) {
            $ = new OspfInstanceState(Objects.requireNonNull(defaults));
        }
        ...
        public OspfInstanceState build() {
            return $;
        }
    }
