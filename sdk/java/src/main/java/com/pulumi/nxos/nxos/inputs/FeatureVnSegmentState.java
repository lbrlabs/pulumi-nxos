...
public final class FeatureVnSegmentState extends com.pulumi.resources.ResourceArgs {

    public static final FeatureVnSegmentState Empty = new FeatureVnSegmentState();
    ...
    private FeatureVnSegmentState() {}

    private FeatureVnSegmentState(FeatureVnSegmentState $) {
    ...
    public static Builder builder(FeatureVnSegmentState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FeatureVnSegmentState();
        }

        public Builder(FeatureVnSegmentState defaults) {
            $ = new FeatureVnSegmentState(Objects.requireNonNull(defaults));
        }
        ...
        public FeatureVnSegmentState build() {
            return $;
        }
    }
