...
public final class FeatureUdldArgs extends com.pulumi.resources.ResourceArgs {

    public static final FeatureUdldArgs Empty = new FeatureUdldArgs();
    ...
    private FeatureUdldArgs() {}

    private FeatureUdldArgs(FeatureUdldArgs $) {
    ...
    public static Builder builder(FeatureUdldArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FeatureUdldArgs defaults) {
            $ = new FeatureUdldArgs(Objects.requireNonNull(defaults));
        }
