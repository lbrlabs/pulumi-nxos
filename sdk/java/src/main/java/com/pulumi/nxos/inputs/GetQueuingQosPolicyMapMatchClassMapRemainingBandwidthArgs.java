...
public final class GetQueuingQosPolicyMapMatchClassMapRemainingBandwidthArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetQueuingQosPolicyMapMatchClassMapRemainingBandwidthArgs Empty = new GetQueuingQosPolicyMapMatchClassMapRemainingBandwidthArgs();
    ...
    private GetQueuingQosPolicyMapMatchClassMapRemainingBandwidthArgs() {}

    private GetQueuingQosPolicyMapMatchClassMapRemainingBandwidthArgs(GetQueuingQosPolicyMapMatchClassMapRemainingBandwidthArgs $) {
    ...
    public static Builder builder(GetQueuingQosPolicyMapMatchClassMapRemainingBandwidthArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetQueuingQosPolicyMapMatchClassMapRemainingBandwidthArgs();
        }

        public Builder(GetQueuingQosPolicyMapMatchClassMapRemainingBandwidthArgs defaults) {
            $ = new GetQueuingQosPolicyMapMatchClassMapRemainingBandwidthArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetQueuingQosPolicyMapMatchClassMapRemainingBandwidthArgs build() {
