...
import com.pulumi.nxos.inputs.BgpPeerTemplateAddressFamilyState;
 ...
 * 
 */
@ResourceType(type="nxos:index/bgpPeerTemplateAddressFamily:BgpPeerTemplateAddressFamily")
public class BgpPeerTemplateAddressFamily extends com.pulumi.resources.CustomResource {
    ...
    public BgpPeerTemplateAddressFamily(String name, BgpPeerTemplateAddressFamilyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:index/bgpPeerTemplateAddressFamily:BgpPeerTemplateAddressFamily", name, args == null ? BgpPeerTemplateAddressFamilyArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private BgpPeerTemplateAddressFamily(String name, Output<String> id, @Nullable BgpPeerTemplateAddressFamilyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:index/bgpPeerTemplateAddressFamily:BgpPeerTemplateAddressFamily", name, state, makeResourceOptions(options, id));
    }
