...
import com.pulumi.nxos.nxos.PhysicalInterfaceArgs;
import com.pulumi.nxos.nxos.inputs.PhysicalInterfaceState;
import java.lang.Integer;
import java.lang.String;
import java.util.Optional;
import javax.annotation.Nullable;

@ResourceType(type="nxos:nxos/physicalInterface:PhysicalInterface")
public class PhysicalInterface extends com.pulumi.resources.CustomResource {
    ...
    public PhysicalInterface(String name, PhysicalInterfaceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/physicalInterface:PhysicalInterface", name, args == null ? PhysicalInterfaceArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private PhysicalInterface(String name, Output<String> id, @Nullable PhysicalInterfaceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/physicalInterface:PhysicalInterface", name, state, makeResourceOptions(options, id));
    }
