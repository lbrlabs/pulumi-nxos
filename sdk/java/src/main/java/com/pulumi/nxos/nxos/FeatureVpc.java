...
import com.pulumi.nxos.nxos.FeatureVpcArgs;
import com.pulumi.nxos.nxos.inputs.FeatureVpcState;
import java.lang.String;
import java.util.Optional;
import javax.annotation.Nullable;

@ResourceType(type="nxos:nxos/featureVpc:FeatureVpc")
public class FeatureVpc extends com.pulumi.resources.CustomResource {
    ...
    public FeatureVpc(String name, FeatureVpcArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/featureVpc:FeatureVpc", name, args == null ? FeatureVpcArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private FeatureVpc(String name, Output<String> id, @Nullable FeatureVpcState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/featureVpc:FeatureVpc", name, state, makeResourceOptions(options, id));
    }
