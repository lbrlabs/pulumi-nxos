...
public final class FeatureBfdArgs extends com.pulumi.resources.ResourceArgs {

    public static final FeatureBfdArgs Empty = new FeatureBfdArgs();
    ...
    private FeatureBfdArgs() {}

    private FeatureBfdArgs(FeatureBfdArgs $) {
    ...
    public static Builder builder(FeatureBfdArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FeatureBfdArgs defaults) {
            $ = new FeatureBfdArgs(Objects.requireNonNull(defaults));
        }
