...
import com.pulumi.nxos.nxos.QueuingQosPolicyMapMatchClassMapPriorityArgs;
import com.pulumi.nxos.nxos.inputs.QueuingQosPolicyMapMatchClassMapPriorityState;
import java.lang.Integer;
import java.lang.String;
import java.util.Optional;
import javax.annotation.Nullable;

@ResourceType(type="nxos:nxos/queuingQosPolicyMapMatchClassMapPriority:QueuingQosPolicyMapMatchClassMapPriority")
public class QueuingQosPolicyMapMatchClassMapPriority extends com.pulumi.resources.CustomResource {
    ...
    public QueuingQosPolicyMapMatchClassMapPriority(String name, QueuingQosPolicyMapMatchClassMapPriorityArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/queuingQosPolicyMapMatchClassMapPriority:QueuingQosPolicyMapMatchClassMapPriority", name, args == null ? QueuingQosPolicyMapMatchClassMapPriorityArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private QueuingQosPolicyMapMatchClassMapPriority(String name, Output<String> id, @Nullable QueuingQosPolicyMapMatchClassMapPriorityState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/queuingQosPolicyMapMatchClassMapPriority:QueuingQosPolicyMapMatchClassMapPriority", name, state, makeResourceOptions(options, id));
    }
