...
public final class FeatureBfdState extends com.pulumi.resources.ResourceArgs {

    public static final FeatureBfdState Empty = new FeatureBfdState();
    ...
    private FeatureBfdState() {}

    private FeatureBfdState(FeatureBfdState $) {
    ...
    public static Builder builder(FeatureBfdState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FeatureBfdState defaults) {
            $ = new FeatureBfdState(Objects.requireNonNull(defaults));
        }
