...
public final class FeatureEvpnState extends com.pulumi.resources.ResourceArgs {

    public static final FeatureEvpnState Empty = new FeatureEvpnState();
    ...
    private FeatureEvpnState() {}

    private FeatureEvpnState(FeatureEvpnState $) {
    ...
    public static Builder builder(FeatureEvpnState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FeatureEvpnState();
        }

        public Builder(FeatureEvpnState defaults) {
            $ = new FeatureEvpnState(Objects.requireNonNull(defaults));
        }
