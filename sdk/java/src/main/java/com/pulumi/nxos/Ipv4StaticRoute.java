...
import com.pulumi.nxos.inputs.Ipv4StaticRouteState;
import com.pulumi.nxos.outputs.Ipv4StaticRouteNextHop;
 ...
 * 
 */
@ResourceType(type="nxos:index/ipv4StaticRoute:Ipv4StaticRoute")
public class Ipv4StaticRoute extends com.pulumi.resources.CustomResource {
    ...
    public Ipv4StaticRoute(String name, Ipv4StaticRouteArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:index/ipv4StaticRoute:Ipv4StaticRoute", name, args == null ? Ipv4StaticRouteArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Ipv4StaticRoute(String name, Output<String> id, @Nullable Ipv4StaticRouteState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:index/ipv4StaticRoute:Ipv4StaticRoute", name, state, makeResourceOptions(options, id));
    }
