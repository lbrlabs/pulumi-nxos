...
import com.pulumi.nxos.nxos.NveInterfaceArgs;
import com.pulumi.nxos.nxos.inputs.NveInterfaceState;
...
@ResourceType(type="nxos:nxos/nveInterface:NveInterface")
public class NveInterface extends com.pulumi.resources.CustomResource {
    ...
    public NveInterface(String name, @Nullable NveInterfaceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/nveInterface:NveInterface", name, args == null ? NveInterfaceArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private NveInterface(String name, Output<String> id, @Nullable NveInterfaceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/nveInterface:NveInterface", name, state, makeResourceOptions(options, id));
    }
