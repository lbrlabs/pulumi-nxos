...
public final class FeatureLldpState extends com.pulumi.resources.ResourceArgs {

    public static final FeatureLldpState Empty = new FeatureLldpState();
    ...
    private FeatureLldpState() {}

    private FeatureLldpState(FeatureLldpState $) {
    ...
    public static Builder builder(FeatureLldpState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FeatureLldpState();
        }

        public Builder(FeatureLldpState defaults) {
            $ = new FeatureLldpState(Objects.requireNonNull(defaults));
        }
