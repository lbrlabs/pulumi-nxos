...
public final class FeatureOspfv3Args extends com.pulumi.resources.ResourceArgs {

    public static final FeatureOspfv3Args Empty = new FeatureOspfv3Args();
    ...
    private FeatureOspfv3Args() {}

    private FeatureOspfv3Args(FeatureOspfv3Args $) {
    ...
    public static Builder builder(FeatureOspfv3Args defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FeatureOspfv3Args();
        }

        public Builder(FeatureOspfv3Args defaults) {
            $ = new FeatureOspfv3Args(Objects.requireNonNull(defaults));
        }
        ...
        public FeatureOspfv3Args build() {
