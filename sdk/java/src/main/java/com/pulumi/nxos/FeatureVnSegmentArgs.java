...
public final class FeatureVnSegmentArgs extends com.pulumi.resources.ResourceArgs {

    public static final FeatureVnSegmentArgs Empty = new FeatureVnSegmentArgs();
    ...
    private FeatureVnSegmentArgs() {}

    private FeatureVnSegmentArgs(FeatureVnSegmentArgs $) {
    ...
    public static Builder builder(FeatureVnSegmentArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FeatureVnSegmentArgs();
        }

        public Builder(FeatureVnSegmentArgs defaults) {
            $ = new FeatureVnSegmentArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FeatureVnSegmentArgs build() {
