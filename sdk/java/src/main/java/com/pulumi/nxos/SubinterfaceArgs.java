...
public final class SubinterfaceArgs extends com.pulumi.resources.ResourceArgs {

    public static final SubinterfaceArgs Empty = new SubinterfaceArgs();
    ...
    private SubinterfaceArgs() {}

    private SubinterfaceArgs(SubinterfaceArgs $) {
    ...
    public static Builder builder(SubinterfaceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SubinterfaceArgs();
        }

        public Builder(SubinterfaceArgs defaults) {
            $ = new SubinterfaceArgs(Objects.requireNonNull(defaults));
        }
