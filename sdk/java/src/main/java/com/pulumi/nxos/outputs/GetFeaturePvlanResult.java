...
@CustomType
public final class GetFeaturePvlanResult {
    /**
    ...
    public static Builder builder(GetFeaturePvlanResult defaults) {
    ...
    public static final class Builder {
        ...
        private String id;
        public Builder() {}
        public Builder(GetFeaturePvlanResult defaults) {
        ...
        public GetFeaturePvlanResult build() {
            final var o = new GetFeaturePvlanResult();
