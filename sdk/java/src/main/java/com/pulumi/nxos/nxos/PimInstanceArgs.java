...
public final class PimInstanceArgs extends com.pulumi.resources.ResourceArgs {

    public static final PimInstanceArgs Empty = new PimInstanceArgs();
    ...
    private PimInstanceArgs() {}

    private PimInstanceArgs(PimInstanceArgs $) {
    ...
    public static Builder builder(PimInstanceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(PimInstanceArgs defaults) {
            $ = new PimInstanceArgs(Objects.requireNonNull(defaults));
        }
