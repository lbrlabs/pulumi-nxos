...
public final class GetBgpPeerAddressFamilyArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetBgpPeerAddressFamilyArgs Empty = new GetBgpPeerAddressFamilyArgs();
    ...
    private GetBgpPeerAddressFamilyArgs() {}

    private GetBgpPeerAddressFamilyArgs(GetBgpPeerAddressFamilyArgs $) {
    ...
    public static Builder builder(GetBgpPeerAddressFamilyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetBgpPeerAddressFamilyArgs();
        }

        public Builder(GetBgpPeerAddressFamilyArgs defaults) {
            $ = new GetBgpPeerAddressFamilyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetBgpPeerAddressFamilyArgs build() {
