...
public final class FeatureDhcpState extends com.pulumi.resources.ResourceArgs {

    public static final FeatureDhcpState Empty = new FeatureDhcpState();
    ...
    private FeatureDhcpState() {}

    private FeatureDhcpState(FeatureDhcpState $) {
    ...
    public static Builder builder(FeatureDhcpState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FeatureDhcpState();
        }

        public Builder(FeatureDhcpState defaults) {
            $ = new FeatureDhcpState(Objects.requireNonNull(defaults));
        }
