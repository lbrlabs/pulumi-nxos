...
public final class PimInterfaceState extends com.pulumi.resources.ResourceArgs {

    public static final PimInterfaceState Empty = new PimInterfaceState();
    ...
    private PimInterfaceState() {}

    private PimInterfaceState(PimInterfaceState $) {
    ...
    public static Builder builder(PimInterfaceState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PimInterfaceState();
        }

        public Builder(PimInterfaceState defaults) {
            $ = new PimInterfaceState(Objects.requireNonNull(defaults));
        }
        ...
        public PimInterfaceState build() {
            return $;
        }
    }
