...
import com.pulumi.nxos.inputs.Ipv4AccessListPolicyIngressInterfaceState;
 ...
 * 
 */
@ResourceType(type="nxos:index/ipv4AccessListPolicyIngressInterface:Ipv4AccessListPolicyIngressInterface")
public class Ipv4AccessListPolicyIngressInterface extends com.pulumi.resources.CustomResource {
    ...
    public Ipv4AccessListPolicyIngressInterface(String name, Ipv4AccessListPolicyIngressInterfaceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:index/ipv4AccessListPolicyIngressInterface:Ipv4AccessListPolicyIngressInterface", name, args == null ? Ipv4AccessListPolicyIngressInterfaceArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Ipv4AccessListPolicyIngressInterface(String name, Output<String> id, @Nullable Ipv4AccessListPolicyIngressInterfaceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:index/ipv4AccessListPolicyIngressInterface:Ipv4AccessListPolicyIngressInterface", name, state, makeResourceOptions(options, id));
    }
