...
public final class HmmState extends com.pulumi.resources.ResourceArgs {

    public static final HmmState Empty = new HmmState();
    ...
    public static Builder builder(HmmState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(HmmState defaults) {
            $ = new HmmState(Objects.requireNonNull(defaults));
        }
