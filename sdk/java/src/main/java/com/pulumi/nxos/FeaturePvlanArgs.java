...
public final class FeaturePvlanArgs extends com.pulumi.resources.ResourceArgs {

    public static final FeaturePvlanArgs Empty = new FeaturePvlanArgs();
    ...
    private FeaturePvlanArgs() {}

    private FeaturePvlanArgs(FeaturePvlanArgs $) {
    ...
    public static Builder builder(FeaturePvlanArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FeaturePvlanArgs();
        }

        public Builder(FeaturePvlanArgs defaults) {
            $ = new FeaturePvlanArgs(Objects.requireNonNull(defaults));
        }
