...
public final class FeatureBgpState extends com.pulumi.resources.ResourceArgs {

    public static final FeatureBgpState Empty = new FeatureBgpState();
    ...
    private FeatureBgpState() {}

    private FeatureBgpState(FeatureBgpState $) {
    ...
    public static Builder builder(FeatureBgpState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FeatureBgpState defaults) {
            $ = new FeatureBgpState(Objects.requireNonNull(defaults));
        }
