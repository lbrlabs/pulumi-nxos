...
import com.pulumi.nxos.nxos.PortChannelInterfaceVrfArgs;
import com.pulumi.nxos.nxos.inputs.PortChannelInterfaceVrfState;
import java.lang.String;
import java.util.Optional;
import javax.annotation.Nullable;

@ResourceType(type="nxos:nxos/portChannelInterfaceVrf:PortChannelInterfaceVrf")
public class PortChannelInterfaceVrf extends com.pulumi.resources.CustomResource {
    ...
    public PortChannelInterfaceVrf(String name, PortChannelInterfaceVrfArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/portChannelInterfaceVrf:PortChannelInterfaceVrf", name, args == null ? PortChannelInterfaceVrfArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private PortChannelInterfaceVrf(String name, Output<String> id, @Nullable PortChannelInterfaceVrfState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/portChannelInterfaceVrf:PortChannelInterfaceVrf", name, state, makeResourceOptions(options, id));
    }
