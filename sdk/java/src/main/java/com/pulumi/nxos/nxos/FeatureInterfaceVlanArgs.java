...
public final class FeatureInterfaceVlanArgs extends com.pulumi.resources.ResourceArgs {

    public static final FeatureInterfaceVlanArgs Empty = new FeatureInterfaceVlanArgs();
    ...
    private FeatureInterfaceVlanArgs() {}

    private FeatureInterfaceVlanArgs(FeatureInterfaceVlanArgs $) {
    ...
    public static Builder builder(FeatureInterfaceVlanArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FeatureInterfaceVlanArgs();
        }

        public Builder(FeatureInterfaceVlanArgs defaults) {
            $ = new FeatureInterfaceVlanArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FeatureInterfaceVlanArgs build() {
