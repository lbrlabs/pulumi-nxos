...
public final class FeatureNvOverlayState extends com.pulumi.resources.ResourceArgs {

    public static final FeatureNvOverlayState Empty = new FeatureNvOverlayState();
    ...
    private FeatureNvOverlayState() {}

    private FeatureNvOverlayState(FeatureNvOverlayState $) {
    ...
    public static Builder builder(FeatureNvOverlayState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FeatureNvOverlayState();
        }

        public Builder(FeatureNvOverlayState defaults) {
            $ = new FeatureNvOverlayState(Objects.requireNonNull(defaults));
        }
        ...
        public FeatureNvOverlayState build() {
            return $;
        }
    }
