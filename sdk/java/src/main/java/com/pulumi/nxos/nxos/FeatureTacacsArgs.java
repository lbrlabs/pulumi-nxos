...
public final class FeatureTacacsArgs extends com.pulumi.resources.ResourceArgs {

    public static final FeatureTacacsArgs Empty = new FeatureTacacsArgs();
    ...
    private FeatureTacacsArgs() {}

    private FeatureTacacsArgs(FeatureTacacsArgs $) {
    ...
    public static Builder builder(FeatureTacacsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FeatureTacacsArgs();
        }

        public Builder(FeatureTacacsArgs defaults) {
            $ = new FeatureTacacsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FeatureTacacsArgs build() {
