...
public final class FeaturePtpState extends com.pulumi.resources.ResourceArgs {

    public static final FeaturePtpState Empty = new FeaturePtpState();
    ...
    private FeaturePtpState() {}

    private FeaturePtpState(FeaturePtpState $) {
    ...
    public static Builder builder(FeaturePtpState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FeaturePtpState defaults) {
            $ = new FeaturePtpState(Objects.requireNonNull(defaults));
        }
