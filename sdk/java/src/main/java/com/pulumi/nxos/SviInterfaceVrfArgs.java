...
public final class SviInterfaceVrfArgs extends com.pulumi.resources.ResourceArgs {

    public static final SviInterfaceVrfArgs Empty = new SviInterfaceVrfArgs();
    ...
    private SviInterfaceVrfArgs() {}

    private SviInterfaceVrfArgs(SviInterfaceVrfArgs $) {
        this.device = $.device;
    ...
    public static Builder builder(SviInterfaceVrfArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SviInterfaceVrfArgs();
        }

        public Builder(SviInterfaceVrfArgs defaults) {
            $ = new SviInterfaceVrfArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SviInterfaceVrfArgs build() {
