...
public final class FeatureHmmState extends com.pulumi.resources.ResourceArgs {

    public static final FeatureHmmState Empty = new FeatureHmmState();
    ...
    private FeatureHmmState() {}

    private FeatureHmmState(FeatureHmmState $) {
    ...
    public static Builder builder(FeatureHmmState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FeatureHmmState defaults) {
            $ = new FeatureHmmState(Objects.requireNonNull(defaults));
        }
