...
public final class FeatureSshState extends com.pulumi.resources.ResourceArgs {

    public static final FeatureSshState Empty = new FeatureSshState();
    ...
    private FeatureSshState() {}

    private FeatureSshState(FeatureSshState $) {
    ...
    public static Builder builder(FeatureSshState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FeatureSshState defaults) {
            $ = new FeatureSshState(Objects.requireNonNull(defaults));
        }
