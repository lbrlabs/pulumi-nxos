...
@CustomType
public final class GetFeaturePimResult {
    ...
    public static Builder builder(GetFeaturePimResult defaults) {
    ...
    public static final class Builder {
        ...
        private String id;
        public Builder() {}
        public Builder(GetFeaturePimResult defaults) {
        ...
        public GetFeaturePimResult build() {
            final var o = new GetFeaturePimResult();
