...
import com.pulumi.nxos.inputs.RouteMapRuleEntrySetRegularCommunityItemState;
 ...
 * 
 */
@ResourceType(type="nxos:index/routeMapRuleEntrySetRegularCommunityItem:RouteMapRuleEntrySetRegularCommunityItem")
public class RouteMapRuleEntrySetRegularCommunityItem extends com.pulumi.resources.CustomResource {
    ...
    public RouteMapRuleEntrySetRegularCommunityItem(String name, RouteMapRuleEntrySetRegularCommunityItemArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:index/routeMapRuleEntrySetRegularCommunityItem:RouteMapRuleEntrySetRegularCommunityItem", name, args == null ? RouteMapRuleEntrySetRegularCommunityItemArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private RouteMapRuleEntrySetRegularCommunityItem(String name, Output<String> id, @Nullable RouteMapRuleEntrySetRegularCommunityItemState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:index/routeMapRuleEntrySetRegularCommunityItem:RouteMapRuleEntrySetRegularCommunityItem", name, state, makeResourceOptions(options, id));
    }
