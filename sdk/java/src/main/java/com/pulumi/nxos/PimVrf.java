...
import com.pulumi.nxos.inputs.PimVrfState;
 ...
 * 
 */
@ResourceType(type="nxos:index/pimVrf:PimVrf")
public class PimVrf extends com.pulumi.resources.CustomResource {
    ...
    public PimVrf(String name, @Nullable PimVrfArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:index/pimVrf:PimVrf", name, args == null ? PimVrfArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private PimVrf(String name, Output<String> id, @Nullable PimVrfState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:index/pimVrf:PimVrf", name, state, makeResourceOptions(options, id));
    }
