...
public final class GetIsisInterfaceArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetIsisInterfaceArgs Empty = new GetIsisInterfaceArgs();
    ...
    private GetIsisInterfaceArgs() {}

    private GetIsisInterfaceArgs(GetIsisInterfaceArgs $) {
        this.device = $.device;
    ...
    public static Builder builder(GetIsisInterfaceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetIsisInterfaceArgs();
        }

        public Builder(GetIsisInterfaceArgs defaults) {
            $ = new GetIsisInterfaceArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetIsisInterfaceArgs build() {
