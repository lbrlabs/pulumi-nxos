...
public final class FeatureDhcpArgs extends com.pulumi.resources.ResourceArgs {

    public static final FeatureDhcpArgs Empty = new FeatureDhcpArgs();
    ...
    private FeatureDhcpArgs() {}

    private FeatureDhcpArgs(FeatureDhcpArgs $) {
    ...
    public static Builder builder(FeatureDhcpArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FeatureDhcpArgs defaults) {
            $ = new FeatureDhcpArgs(Objects.requireNonNull(defaults));
        }
