...
@CustomType
public final class GetPhysicalInterfaceVrfResult {
    /**
    ...
    public static Builder builder(GetPhysicalInterfaceVrfResult defaults) {
    ...
    public static final class Builder {
        ...
        private String vrfDn;
        public Builder() {}
        public Builder(GetPhysicalInterfaceVrfResult defaults) {
        ...
        public GetPhysicalInterfaceVrfResult build() {
            final var o = new GetPhysicalInterfaceVrfResult();
            o.device = device;
            o.id = id;
