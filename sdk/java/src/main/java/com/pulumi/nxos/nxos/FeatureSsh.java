...
import com.pulumi.nxos.nxos.FeatureSshArgs;
import com.pulumi.nxos.nxos.inputs.FeatureSshState;
import java.lang.String;
import java.util.Optional;
import javax.annotation.Nullable;

@ResourceType(type="nxos:nxos/featureSsh:FeatureSsh")
public class FeatureSsh extends com.pulumi.resources.CustomResource {
    ...
    public FeatureSsh(String name, FeatureSshArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/featureSsh:FeatureSsh", name, args == null ? FeatureSshArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private FeatureSsh(String name, Output<String> id, @Nullable FeatureSshState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/featureSsh:FeatureSsh", name, state, makeResourceOptions(options, id));
    }
