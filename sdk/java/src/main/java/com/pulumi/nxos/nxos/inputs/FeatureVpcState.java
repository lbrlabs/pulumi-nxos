...
public final class FeatureVpcState extends com.pulumi.resources.ResourceArgs {

    public static final FeatureVpcState Empty = new FeatureVpcState();
    ...
    private FeatureVpcState() {}

    private FeatureVpcState(FeatureVpcState $) {
    ...
    public static Builder builder(FeatureVpcState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FeatureVpcState defaults) {
            $ = new FeatureVpcState(Objects.requireNonNull(defaults));
        }
