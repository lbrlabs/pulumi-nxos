...
public final class FeatureLldpArgs extends com.pulumi.resources.ResourceArgs {

    public static final FeatureLldpArgs Empty = new FeatureLldpArgs();
    ...
    private FeatureLldpArgs() {}

    private FeatureLldpArgs(FeatureLldpArgs $) {
    ...
    public static Builder builder(FeatureLldpArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FeatureLldpArgs defaults) {
            $ = new FeatureLldpArgs(Objects.requireNonNull(defaults));
        }
