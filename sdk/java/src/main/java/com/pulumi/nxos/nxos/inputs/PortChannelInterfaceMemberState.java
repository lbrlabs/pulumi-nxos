...
public final class PortChannelInterfaceMemberState extends com.pulumi.resources.ResourceArgs {

    public static final PortChannelInterfaceMemberState Empty = new PortChannelInterfaceMemberState();
     ...
     * 
     */
    @Import(name="interfaceDn")
    private @Nullable Output<String> interfaceDn;

    /**
     * @return DN of interface. For example: `sys/intf/phys-[eth1/1]`.
     * 
     */
    public Optional<Output<String>> interfaceDn() {
        return Optional.ofNullable(this.interfaceDn);
    }
    ...
    private PortChannelInterfaceMemberState() {}

    private PortChannelInterfaceMemberState(PortChannelInterfaceMemberState $) {
        this.device = $.device;
    ...
    public static Builder builder(PortChannelInterfaceMemberState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PortChannelInterfaceMemberState();
        }

        public Builder(PortChannelInterfaceMemberState defaults) {
            $ = new PortChannelInterfaceMemberState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder interfaceDn(@Nullable Output<String> interfaceDn) {
        ...
        public PortChannelInterfaceMemberState build() {
            return $;
        }
    }
