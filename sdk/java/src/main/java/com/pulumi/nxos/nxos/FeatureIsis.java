...
import com.pulumi.nxos.nxos.FeatureIsisArgs;
import com.pulumi.nxos.nxos.inputs.FeatureIsisState;
import java.lang.String;
import java.util.Optional;
import javax.annotation.Nullable;

@ResourceType(type="nxos:nxos/featureIsis:FeatureIsis")
public class FeatureIsis extends com.pulumi.resources.CustomResource {
    ...
    public FeatureIsis(String name, FeatureIsisArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/featureIsis:FeatureIsis", name, args == null ? FeatureIsisArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private FeatureIsis(String name, Output<String> id, @Nullable FeatureIsisState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/featureIsis:FeatureIsis", name, state, makeResourceOptions(options, id));
    }
