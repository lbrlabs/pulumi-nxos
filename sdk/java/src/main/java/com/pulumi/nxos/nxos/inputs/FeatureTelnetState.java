...
public final class FeatureTelnetState extends com.pulumi.resources.ResourceArgs {

    public static final FeatureTelnetState Empty = new FeatureTelnetState();
    ...
    private FeatureTelnetState() {}

    private FeatureTelnetState(FeatureTelnetState $) {
    ...
    public static Builder builder(FeatureTelnetState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FeatureTelnetState();
        }

        public Builder(FeatureTelnetState defaults) {
            $ = new FeatureTelnetState(Objects.requireNonNull(defaults));
        }
        ...
        public FeatureTelnetState build() {
            return $;
        }
    }
