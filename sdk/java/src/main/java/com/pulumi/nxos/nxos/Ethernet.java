...
import com.pulumi.nxos.nxos.EthernetArgs;
import com.pulumi.nxos.nxos.inputs.EthernetState;
import java.lang.Integer;
import java.lang.String;
import java.util.Optional;
import javax.annotation.Nullable;

@ResourceType(type="nxos:nxos/ethernet:Ethernet")
public class Ethernet extends com.pulumi.resources.CustomResource {
    ...
    public Ethernet(String name, @Nullable EthernetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/ethernet:Ethernet", name, args == null ? EthernetArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Ethernet(String name, Output<String> id, @Nullable EthernetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/ethernet:Ethernet", name, state, makeResourceOptions(options, id));
    }
