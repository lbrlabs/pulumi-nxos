...
public final class FeaturePimState extends com.pulumi.resources.ResourceArgs {

    public static final FeaturePimState Empty = new FeaturePimState();
    ...
    private FeaturePimState() {}

    private FeaturePimState(FeaturePimState $) {
    ...
    public static Builder builder(FeaturePimState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FeaturePimState defaults) {
            $ = new FeaturePimState(Objects.requireNonNull(defaults));
        }
