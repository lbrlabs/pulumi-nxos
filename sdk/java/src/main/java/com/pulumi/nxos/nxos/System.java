...
import com.pulumi.nxos.nxos.SystemArgs;
import com.pulumi.nxos.nxos.inputs.SystemState;
import java.lang.String;
import java.util.Optional;
import javax.annotation.Nullable;

@ResourceType(type="nxos:nxos/system:System")
public class System extends com.pulumi.resources.CustomResource {
    ...
    public System(String name, @Nullable SystemArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/system:System", name, args == null ? SystemArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private System(String name, Output<String> id, @Nullable SystemState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/system:System", name, state, makeResourceOptions(options, id));
    }
