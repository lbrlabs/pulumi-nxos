...
import com.pulumi.nxos.inputs.VrfRouteTargetDirectionState;
 ...
 * 
 */
@ResourceType(type="nxos:index/vrfRouteTargetDirection:VrfRouteTargetDirection")
public class VrfRouteTargetDirection extends com.pulumi.resources.CustomResource {
    ...
    public VrfRouteTargetDirection(String name, VrfRouteTargetDirectionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:index/vrfRouteTargetDirection:VrfRouteTargetDirection", name, args == null ? VrfRouteTargetDirectionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private VrfRouteTargetDirection(String name, Output<String> id, @Nullable VrfRouteTargetDirectionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:index/vrfRouteTargetDirection:VrfRouteTargetDirection", name, state, makeResourceOptions(options, id));
    }
