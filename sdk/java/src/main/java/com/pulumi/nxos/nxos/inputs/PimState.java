...
public final class PimState extends com.pulumi.resources.ResourceArgs {

    public static final PimState Empty = new PimState();
    ...
    public static Builder builder(PimState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(PimState defaults) {
            $ = new PimState(Objects.requireNonNull(defaults));
        }
