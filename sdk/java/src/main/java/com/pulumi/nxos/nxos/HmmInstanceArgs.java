...
public final class HmmInstanceArgs extends com.pulumi.resources.ResourceArgs {

    public static final HmmInstanceArgs Empty = new HmmInstanceArgs();
    ...
    private HmmInstanceArgs() {}

    private HmmInstanceArgs(HmmInstanceArgs $) {
    ...
    public static Builder builder(HmmInstanceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(HmmInstanceArgs defaults) {
            $ = new HmmInstanceArgs(Objects.requireNonNull(defaults));
        }
