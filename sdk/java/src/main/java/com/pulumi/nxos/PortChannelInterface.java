...
import com.pulumi.nxos.inputs.PortChannelInterfaceState;
 ...
 * 
 */
@ResourceType(type="nxos:index/portChannelInterface:PortChannelInterface")
public class PortChannelInterface extends com.pulumi.resources.CustomResource {
    ...
    public PortChannelInterface(String name, PortChannelInterfaceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:index/portChannelInterface:PortChannelInterface", name, args == null ? PortChannelInterfaceArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private PortChannelInterface(String name, Output<String> id, @Nullable PortChannelInterfaceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:index/portChannelInterface:PortChannelInterface", name, state, makeResourceOptions(options, id));
    }
