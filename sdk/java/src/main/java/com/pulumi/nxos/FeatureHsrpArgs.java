...
public final class FeatureHsrpArgs extends com.pulumi.resources.ResourceArgs {

    public static final FeatureHsrpArgs Empty = new FeatureHsrpArgs();
    ...
    private FeatureHsrpArgs() {}

    private FeatureHsrpArgs(FeatureHsrpArgs $) {
    ...
    public static Builder builder(FeatureHsrpArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FeatureHsrpArgs defaults) {
            $ = new FeatureHsrpArgs(Objects.requireNonNull(defaults));
        }
