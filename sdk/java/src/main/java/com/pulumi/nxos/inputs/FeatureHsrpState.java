...
public final class FeatureHsrpState extends com.pulumi.resources.ResourceArgs {

    public static final FeatureHsrpState Empty = new FeatureHsrpState();
    ...
    private FeatureHsrpState() {}

    private FeatureHsrpState(FeatureHsrpState $) {
    ...
    public static Builder builder(FeatureHsrpState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FeatureHsrpState();
        }

        public Builder(FeatureHsrpState defaults) {
            $ = new FeatureHsrpState(Objects.requireNonNull(defaults));
        }
