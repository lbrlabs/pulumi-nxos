...
public final class FeaturePtpArgs extends com.pulumi.resources.ResourceArgs {

    public static final FeaturePtpArgs Empty = new FeaturePtpArgs();
    ...
    private FeaturePtpArgs() {}

    private FeaturePtpArgs(FeaturePtpArgs $) {
    ...
    public static Builder builder(FeaturePtpArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FeaturePtpArgs defaults) {
            $ = new FeaturePtpArgs(Objects.requireNonNull(defaults));
        }
