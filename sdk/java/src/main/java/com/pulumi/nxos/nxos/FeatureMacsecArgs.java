...
public final class FeatureMacsecArgs extends com.pulumi.resources.ResourceArgs {

    public static final FeatureMacsecArgs Empty = new FeatureMacsecArgs();
    ...
    private FeatureMacsecArgs() {}

    private FeatureMacsecArgs(FeatureMacsecArgs $) {
    ...
    public static Builder builder(FeatureMacsecArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FeatureMacsecArgs();
        }

        public Builder(FeatureMacsecArgs defaults) {
            $ = new FeatureMacsecArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FeatureMacsecArgs build() {
