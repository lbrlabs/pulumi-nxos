...
@CustomType
public final class GetIsisResult {
    ...
    public static Builder builder(GetIsisResult defaults) {
    ...
    public static final class Builder {
        ...
        private String id;
        public Builder() {}
        public Builder(GetIsisResult defaults) {
        ...
        public GetIsisResult build() {
            final var o = new GetIsisResult();
