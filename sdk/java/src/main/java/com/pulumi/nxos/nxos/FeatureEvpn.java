...
import com.pulumi.nxos.nxos.FeatureEvpnArgs;
import com.pulumi.nxos.nxos.inputs.FeatureEvpnState;
import java.lang.String;
import java.util.Optional;
import javax.annotation.Nullable;

@ResourceType(type="nxos:nxos/featureEvpn:FeatureEvpn")
public class FeatureEvpn extends com.pulumi.resources.CustomResource {
    ...
    public FeatureEvpn(String name, FeatureEvpnArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/featureEvpn:FeatureEvpn", name, args == null ? FeatureEvpnArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private FeatureEvpn(String name, Output<String> id, @Nullable FeatureEvpnState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/featureEvpn:FeatureEvpn", name, state, makeResourceOptions(options, id));
    }
