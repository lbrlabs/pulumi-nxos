...
public final class VrfRoutingArgs extends com.pulumi.resources.ResourceArgs {

    public static final VrfRoutingArgs Empty = new VrfRoutingArgs();
    ...
    private VrfRoutingArgs() {}

    private VrfRoutingArgs(VrfRoutingArgs $) {
        this.device = $.device;
    ...
    public static Builder builder(VrfRoutingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(VrfRoutingArgs defaults) {
            $ = new VrfRoutingArgs(Objects.requireNonNull(defaults));
        }
