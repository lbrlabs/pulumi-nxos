...
public final class FeatureBgpArgs extends com.pulumi.resources.ResourceArgs {

    public static final FeatureBgpArgs Empty = new FeatureBgpArgs();
    ...
    private FeatureBgpArgs() {}

    private FeatureBgpArgs(FeatureBgpArgs $) {
    ...
    public static Builder builder(FeatureBgpArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FeatureBgpArgs defaults) {
            $ = new FeatureBgpArgs(Objects.requireNonNull(defaults));
        }
