...
import com.pulumi.nxos.inputs.Ipv4PrefixListRuleEntryState;
 ...
 * 
 */
@ResourceType(type="nxos:index/ipv4PrefixListRuleEntry:Ipv4PrefixListRuleEntry")
public class Ipv4PrefixListRuleEntry extends com.pulumi.resources.CustomResource {
    ...
    public Ipv4PrefixListRuleEntry(String name, Ipv4PrefixListRuleEntryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:index/ipv4PrefixListRuleEntry:Ipv4PrefixListRuleEntry", name, args == null ? Ipv4PrefixListRuleEntryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Ipv4PrefixListRuleEntry(String name, Output<String> id, @Nullable Ipv4PrefixListRuleEntryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:index/ipv4PrefixListRuleEntry:Ipv4PrefixListRuleEntry", name, state, makeResourceOptions(options, id));
    }
