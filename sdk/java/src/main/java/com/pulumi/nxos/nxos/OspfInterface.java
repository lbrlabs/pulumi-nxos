...
import com.pulumi.nxos.nxos.OspfInterfaceArgs;
import com.pulumi.nxos.nxos.inputs.OspfInterfaceState;
...
@ResourceType(type="nxos:nxos/ospfInterface:OspfInterface")
public class OspfInterface extends com.pulumi.resources.CustomResource {
    ...
    public OspfInterface(String name, OspfInterfaceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/ospfInterface:OspfInterface", name, args == null ? OspfInterfaceArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private OspfInterface(String name, Output<String> id, @Nullable OspfInterfaceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/ospfInterface:OspfInterface", name, state, makeResourceOptions(options, id));
    }
