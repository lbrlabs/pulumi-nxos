...
import com.pulumi.nxos.nxos.SubinterfaceVrfArgs;
import com.pulumi.nxos.nxos.inputs.SubinterfaceVrfState;
import java.lang.String;
import java.util.Optional;
import javax.annotation.Nullable;

@ResourceType(type="nxos:nxos/subinterfaceVrf:SubinterfaceVrf")
public class SubinterfaceVrf extends com.pulumi.resources.CustomResource {
    ...
    public SubinterfaceVrf(String name, SubinterfaceVrfArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/subinterfaceVrf:SubinterfaceVrf", name, args == null ? SubinterfaceVrfArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private SubinterfaceVrf(String name, Output<String> id, @Nullable SubinterfaceVrfState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/subinterfaceVrf:SubinterfaceVrf", name, state, makeResourceOptions(options, id));
    }
