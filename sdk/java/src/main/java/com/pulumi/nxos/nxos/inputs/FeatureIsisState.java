...
public final class FeatureIsisState extends com.pulumi.resources.ResourceArgs {

    public static final FeatureIsisState Empty = new FeatureIsisState();
    ...
    private FeatureIsisState() {}

    private FeatureIsisState(FeatureIsisState $) {
    ...
    public static Builder builder(FeatureIsisState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FeatureIsisState();
        }

        public Builder(FeatureIsisState defaults) {
            $ = new FeatureIsisState(Objects.requireNonNull(defaults));
        }
