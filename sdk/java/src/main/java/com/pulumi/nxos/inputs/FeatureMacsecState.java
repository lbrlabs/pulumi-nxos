...
public final class FeatureMacsecState extends com.pulumi.resources.ResourceArgs {

    public static final FeatureMacsecState Empty = new FeatureMacsecState();
    ...
    private FeatureMacsecState() {}

    private FeatureMacsecState(FeatureMacsecState $) {
    ...
    public static Builder builder(FeatureMacsecState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FeatureMacsecState();
        }

        public Builder(FeatureMacsecState defaults) {
            $ = new FeatureMacsecState(Objects.requireNonNull(defaults));
        }
        ...
        public FeatureMacsecState build() {
            return $;
        }
    }
