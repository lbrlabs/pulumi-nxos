...
public final class NveInterfaceArgs extends com.pulumi.resources.ResourceArgs {

    public static final NveInterfaceArgs Empty = new NveInterfaceArgs();
    ...
    private NveInterfaceArgs() {}

    private NveInterfaceArgs(NveInterfaceArgs $) {
    ...
    public static Builder builder(NveInterfaceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NveInterfaceArgs();
        }

        public Builder(NveInterfaceArgs defaults) {
            $ = new NveInterfaceArgs(Objects.requireNonNull(defaults));
        }
