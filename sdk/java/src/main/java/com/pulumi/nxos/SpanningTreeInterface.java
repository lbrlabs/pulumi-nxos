...
import com.pulumi.nxos.inputs.SpanningTreeInterfaceState;
 ...
 * 
 */
@ResourceType(type="nxos:index/spanningTreeInterface:SpanningTreeInterface")
public class SpanningTreeInterface extends com.pulumi.resources.CustomResource {
    ...
    public SpanningTreeInterface(String name, SpanningTreeInterfaceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:index/spanningTreeInterface:SpanningTreeInterface", name, args == null ? SpanningTreeInterfaceArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private SpanningTreeInterface(String name, Output<String> id, @Nullable SpanningTreeInterfaceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:index/spanningTreeInterface:SpanningTreeInterface", name, state, makeResourceOptions(options, id));
    }
