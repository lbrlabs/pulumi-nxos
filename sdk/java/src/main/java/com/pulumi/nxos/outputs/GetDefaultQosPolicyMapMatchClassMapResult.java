...
@CustomType
public final class GetDefaultQosPolicyMapMatchClassMapResult {
    /**
    ...
    public static Builder builder(GetDefaultQosPolicyMapMatchClassMapResult defaults) {
    ...
    public static final class Builder {
        ...
        private String policyMapName;
        public Builder() {}
        public Builder(GetDefaultQosPolicyMapMatchClassMapResult defaults) {
        ...
        public GetDefaultQosPolicyMapMatchClassMapResult build() {
            final var o = new GetDefaultQosPolicyMapMatchClassMapResult();
            o.device = device;
            o.id = id;
            o.name = name;
