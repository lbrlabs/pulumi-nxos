...
public final class FeatureEvpnArgs extends com.pulumi.resources.ResourceArgs {

    public static final FeatureEvpnArgs Empty = new FeatureEvpnArgs();
    ...
    private FeatureEvpnArgs() {}

    private FeatureEvpnArgs(FeatureEvpnArgs $) {
    ...
    public static Builder builder(FeatureEvpnArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FeatureEvpnArgs defaults) {
            $ = new FeatureEvpnArgs(Objects.requireNonNull(defaults));
        }
