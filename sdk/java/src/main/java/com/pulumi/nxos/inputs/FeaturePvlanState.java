...
public final class FeaturePvlanState extends com.pulumi.resources.ResourceArgs {

    public static final FeaturePvlanState Empty = new FeaturePvlanState();
    ...
    private FeaturePvlanState() {}

    private FeaturePvlanState(FeaturePvlanState $) {
    ...
    public static Builder builder(FeaturePvlanState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FeaturePvlanState();
        }

        public Builder(FeaturePvlanState defaults) {
            $ = new FeaturePvlanState(Objects.requireNonNull(defaults));
        }
        ...
        public FeaturePvlanState build() {
            return $;
        }
    }
