...
public final class FeatureHmmArgs extends com.pulumi.resources.ResourceArgs {

    public static final FeatureHmmArgs Empty = new FeatureHmmArgs();
    ...
    private FeatureHmmArgs() {}

    private FeatureHmmArgs(FeatureHmmArgs $) {
    ...
    public static Builder builder(FeatureHmmArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FeatureHmmArgs defaults) {
            $ = new FeatureHmmArgs(Objects.requireNonNull(defaults));
        }
