...
public final class FeatureNetflowArgs extends com.pulumi.resources.ResourceArgs {

    public static final FeatureNetflowArgs Empty = new FeatureNetflowArgs();
    ...
    private FeatureNetflowArgs() {}

    private FeatureNetflowArgs(FeatureNetflowArgs $) {
    ...
    public static Builder builder(FeatureNetflowArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FeatureNetflowArgs();
        }

        public Builder(FeatureNetflowArgs defaults) {
            $ = new FeatureNetflowArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FeatureNetflowArgs build() {
