...
public final class FeatureTacacsState extends com.pulumi.resources.ResourceArgs {

    public static final FeatureTacacsState Empty = new FeatureTacacsState();
    ...
    private FeatureTacacsState() {}

    private FeatureTacacsState(FeatureTacacsState $) {
    ...
    public static Builder builder(FeatureTacacsState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FeatureTacacsState();
        }

        public Builder(FeatureTacacsState defaults) {
            $ = new FeatureTacacsState(Objects.requireNonNull(defaults));
        }
        ...
        public FeatureTacacsState build() {
            return $;
        }
    }
