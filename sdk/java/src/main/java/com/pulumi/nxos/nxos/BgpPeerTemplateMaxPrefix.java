...
import com.pulumi.nxos.nxos.BgpPeerTemplateMaxPrefixArgs;
import com.pulumi.nxos.nxos.inputs.BgpPeerTemplateMaxPrefixState;
import java.lang.Integer;
import java.lang.String;
import java.util.Optional;
import javax.annotation.Nullable;

@ResourceType(type="nxos:nxos/bgpPeerTemplateMaxPrefix:BgpPeerTemplateMaxPrefix")
public class BgpPeerTemplateMaxPrefix extends com.pulumi.resources.CustomResource {
    ...
    public BgpPeerTemplateMaxPrefix(String name, BgpPeerTemplateMaxPrefixArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/bgpPeerTemplateMaxPrefix:BgpPeerTemplateMaxPrefix", name, args == null ? BgpPeerTemplateMaxPrefixArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private BgpPeerTemplateMaxPrefix(String name, Output<String> id, @Nullable BgpPeerTemplateMaxPrefixState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:nxos/bgpPeerTemplateMaxPrefix:BgpPeerTemplateMaxPrefix", name, state, makeResourceOptions(options, id));
    }
