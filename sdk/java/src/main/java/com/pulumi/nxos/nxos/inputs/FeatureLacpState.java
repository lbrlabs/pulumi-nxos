...
public final class FeatureLacpState extends com.pulumi.resources.ResourceArgs {

    public static final FeatureLacpState Empty = new FeatureLacpState();
    ...
    private FeatureLacpState() {}

    private FeatureLacpState(FeatureLacpState $) {
    ...
    public static Builder builder(FeatureLacpState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FeatureLacpState();
        }

        public Builder(FeatureLacpState defaults) {
            $ = new FeatureLacpState(Objects.requireNonNull(defaults));
        }
