...
public final class VpcInstanceState extends com.pulumi.resources.ResourceArgs {

    public static final VpcInstanceState Empty = new VpcInstanceState();
    ...
    private VpcInstanceState() {}

    private VpcInstanceState(VpcInstanceState $) {
    ...
    public static Builder builder(VpcInstanceState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VpcInstanceState();
        }

        public Builder(VpcInstanceState defaults) {
            $ = new VpcInstanceState(Objects.requireNonNull(defaults));
        }
