...
public final class FeatureIsisArgs extends com.pulumi.resources.ResourceArgs {

    public static final FeatureIsisArgs Empty = new FeatureIsisArgs();
    ...
    private FeatureIsisArgs() {}

    private FeatureIsisArgs(FeatureIsisArgs $) {
    ...
    public static Builder builder(FeatureIsisArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(FeatureIsisArgs defaults) {
            $ = new FeatureIsisArgs(Objects.requireNonNull(defaults));
        }
