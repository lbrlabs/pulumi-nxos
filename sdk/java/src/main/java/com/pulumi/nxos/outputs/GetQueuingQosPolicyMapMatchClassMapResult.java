...
@CustomType
public final class GetQueuingQosPolicyMapMatchClassMapResult {
    /**
    ...
    public static Builder builder(GetQueuingQosPolicyMapMatchClassMapResult defaults) {
    ...
    public static final class Builder {
        ...
        private String policyMapName;
        public Builder() {}
        public Builder(GetQueuingQosPolicyMapMatchClassMapResult defaults) {
        ...
        public GetQueuingQosPolicyMapMatchClassMapResult build() {
            final var o = new GetQueuingQosPolicyMapMatchClassMapResult();
            o.device = device;
            o.id = id;
            o.name = name;
