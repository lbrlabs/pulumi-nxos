...
import com.pulumi.nxos.inputs.BgpAdvertisedPrefixState;
 ...
 * 
 */
@ResourceType(type="nxos:index/bgpAdvertisedPrefix:BgpAdvertisedPrefix")
public class BgpAdvertisedPrefix extends com.pulumi.resources.CustomResource {
    ...
    public BgpAdvertisedPrefix(String name, BgpAdvertisedPrefixArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:index/bgpAdvertisedPrefix:BgpAdvertisedPrefix", name, args == null ? BgpAdvertisedPrefixArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private BgpAdvertisedPrefix(String name, Output<String> id, @Nullable BgpAdvertisedPrefixState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("nxos:index/bgpAdvertisedPrefix:BgpAdvertisedPrefix", name, state, makeResourceOptions(options, id));
    }
