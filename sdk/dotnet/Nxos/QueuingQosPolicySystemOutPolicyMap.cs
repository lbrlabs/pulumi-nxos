...
namespace Lbrlabs.PulumiPackage.Nxos
{
    ...
    /// ```
    /// </summary>
    [NxosResourceType("nxos:index/queuingQosPolicySystemOutPolicyMap:QueuingQosPolicySystemOutPolicyMap")]
    public partial class QueuingQosPolicySystemOutPolicyMap : global::Pulumi.CustomResource
    {
        ...
        public QueuingQosPolicySystemOutPolicyMap(string name, QueuingQosPolicySystemOutPolicyMapArgs args, CustomResourceOptions? options = null)
            : base("nxos:index/queuingQosPolicySystemOutPolicyMap:QueuingQosPolicySystemOutPolicyMap", name, args ?? new QueuingQosPolicySystemOutPolicyMapArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private QueuingQosPolicySystemOutPolicyMap(string name, Input<string> id, QueuingQosPolicySystemOutPolicyMapState? state = null, CustomResourceOptions? options = null)
            : base("nxos:index/queuingQosPolicySystemOutPolicyMap:QueuingQosPolicySystemOutPolicyMap", name, state, MakeResourceOptions(options, id))
        {
        }
