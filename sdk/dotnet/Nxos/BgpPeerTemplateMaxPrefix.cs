...
namespace Lbrlabs.PulumiPackage.Nxos
{
    ...
    /// ```
    /// </summary>
    [NxosResourceType("nxos:index/bgpPeerTemplateMaxPrefix:BgpPeerTemplateMaxPrefix")]
    public partial class BgpPeerTemplateMaxPrefix : global::Pulumi.CustomResource
    {
        ...
        public BgpPeerTemplateMaxPrefix(string name, BgpPeerTemplateMaxPrefixArgs args, CustomResourceOptions? options = null)
            : base("nxos:index/bgpPeerTemplateMaxPrefix:BgpPeerTemplateMaxPrefix", name, args ?? new BgpPeerTemplateMaxPrefixArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private BgpPeerTemplateMaxPrefix(string name, Input<string> id, BgpPeerTemplateMaxPrefixState? state = null, CustomResourceOptions? options = null)
            : base("nxos:index/bgpPeerTemplateMaxPrefix:BgpPeerTemplateMaxPrefix", name, state, MakeResourceOptions(options, id))
        {
        }
