...
namespace Lbrlabs.PulumiPackage.Nxos
{
    ...
    /// ```
    /// </summary>
    [NxosResourceType("nxos:index/bgp:Bgp")]
    public partial class Bgp : global::Pulumi.CustomResource
    {
        ...
        public Bgp(string name, BgpArgs? args = null, CustomResourceOptions? options = null)
            : base("nxos:index/bgp:Bgp", name, args ?? new BgpArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Bgp(string name, Input<string> id, BgpState? state = null, CustomResourceOptions? options = null)
            : base("nxos:index/bgp:Bgp", name, state, MakeResourceOptions(options, id))
        {
        }
