...
namespace Lbrlabs.PulumiPackage.Nxos
{
    ...
    /// ```
    /// </summary>
    [NxosResourceType("nxos:index/ipv4PrefixListRuleEntry:Ipv4PrefixListRuleEntry")]
    public partial class Ipv4PrefixListRuleEntry : global::Pulumi.CustomResource
    {
        ...
        public Ipv4PrefixListRuleEntry(string name, Ipv4PrefixListRuleEntryArgs args, CustomResourceOptions? options = null)
            : base("nxos:index/ipv4PrefixListRuleEntry:Ipv4PrefixListRuleEntry", name, args ?? new Ipv4PrefixListRuleEntryArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private Ipv4PrefixListRuleEntry(string name, Input<string> id, Ipv4PrefixListRuleEntryState? state = null, CustomResourceOptions? options = null)
            : base("nxos:index/ipv4PrefixListRuleEntry:Ipv4PrefixListRuleEntry", name, state, MakeResourceOptions(options, id))
        {
        }
