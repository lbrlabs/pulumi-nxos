...
namespace Lbrlabs.PulumiPackage.Nxos
{
    ...
    /// ```
    /// </summary>
    [NxosResourceType("nxos:index/defaultQosPolicyMapMatchClassMap:DefaultQosPolicyMapMatchClassMap")]
    public partial class DefaultQosPolicyMapMatchClassMap : global::Pulumi.CustomResource
    {
        ...
        public DefaultQosPolicyMapMatchClassMap(string name, DefaultQosPolicyMapMatchClassMapArgs args, CustomResourceOptions? options = null)
            : base("nxos:index/defaultQosPolicyMapMatchClassMap:DefaultQosPolicyMapMatchClassMap", name, args ?? new DefaultQosPolicyMapMatchClassMapArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private DefaultQosPolicyMapMatchClassMap(string name, Input<string> id, DefaultQosPolicyMapMatchClassMapState? state = null, CustomResourceOptions? options = null)
            : base("nxos:index/defaultQosPolicyMapMatchClassMap:DefaultQosPolicyMapMatchClassMap", name, state, MakeResourceOptions(options, id))
        {
        }
