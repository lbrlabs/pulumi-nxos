...
namespace Lbrlabs.PulumiPackage.Nxos
{
    ...
    /// ```
    /// </summary>
    [NxosResourceType("nxos:index/ospf:Ospf")]
    public partial class Ospf : global::Pulumi.CustomResource
    {
        ...
        public Ospf(string name, OspfArgs? args = null, CustomResourceOptions? options = null)
            : base("nxos:index/ospf:Ospf", name, args ?? new OspfArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Ospf(string name, Input<string> id, OspfState? state = null, CustomResourceOptions? options = null)
            : base("nxos:index/ospf:Ospf", name, state, MakeResourceOptions(options, id))
        {
        }
