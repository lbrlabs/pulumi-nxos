...
namespace Lbrlabs.PulumiPackage.Nxos
{
    ...
    /// ```
    /// </summary>
    [NxosResourceType("nxos:index/routeMapRuleEntryMatchRoutePrefixList:RouteMapRuleEntryMatchRoutePrefixList")]
    public partial class RouteMapRuleEntryMatchRoutePrefixList : global::Pulumi.CustomResource
    {
        ...
        public RouteMapRuleEntryMatchRoutePrefixList(string name, RouteMapRuleEntryMatchRoutePrefixListArgs args, CustomResourceOptions? options = null)
            : base("nxos:index/routeMapRuleEntryMatchRoutePrefixList:RouteMapRuleEntryMatchRoutePrefixList", name, args ?? new RouteMapRuleEntryMatchRoutePrefixListArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private RouteMapRuleEntryMatchRoutePrefixList(string name, Input<string> id, RouteMapRuleEntryMatchRoutePrefixListState? state = null, CustomResourceOptions? options = null)
            : base("nxos:index/routeMapRuleEntryMatchRoutePrefixList:RouteMapRuleEntryMatchRoutePrefixList", name, state, MakeResourceOptions(options, id))
        {
        }
