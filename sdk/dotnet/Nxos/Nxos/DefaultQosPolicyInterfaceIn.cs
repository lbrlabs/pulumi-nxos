...
{
    [NxosResourceType("nxos:nxos/defaultQosPolicyInterfaceIn:DefaultQosPolicyInterfaceIn")]
    public partial class DefaultQosPolicyInterfaceIn : global::Pulumi.CustomResource
    {
        ...
        public DefaultQosPolicyInterfaceIn(string name, DefaultQosPolicyInterfaceInArgs args, CustomResourceOptions? options = null)
            : base("nxos:nxos/defaultQosPolicyInterfaceIn:DefaultQosPolicyInterfaceIn", name, args ?? new DefaultQosPolicyInterfaceInArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private DefaultQosPolicyInterfaceIn(string name, Input<string> id, DefaultQosPolicyInterfaceInState? state = null, CustomResourceOptions? options = null)
            : base("nxos:nxos/defaultQosPolicyInterfaceIn:DefaultQosPolicyInterfaceIn", name, state, MakeResourceOptions(options, id))
        {
        }
