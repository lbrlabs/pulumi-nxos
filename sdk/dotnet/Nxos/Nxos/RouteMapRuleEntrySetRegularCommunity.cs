...
{
    [NxosResourceType("nxos:nxos/routeMapRuleEntrySetRegularCommunity:RouteMapRuleEntrySetRegularCommunity")]
    public partial class RouteMapRuleEntrySetRegularCommunity : global::Pulumi.CustomResource
    {
        ...
        public RouteMapRuleEntrySetRegularCommunity(string name, RouteMapRuleEntrySetRegularCommunityArgs args, CustomResourceOptions? options = null)
            : base("nxos:nxos/routeMapRuleEntrySetRegularCommunity:RouteMapRuleEntrySetRegularCommunity", name, args ?? new RouteMapRuleEntrySetRegularCommunityArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private RouteMapRuleEntrySetRegularCommunity(string name, Input<string> id, RouteMapRuleEntrySetRegularCommunityState? state = null, CustomResourceOptions? options = null)
            : base("nxos:nxos/routeMapRuleEntrySetRegularCommunity:RouteMapRuleEntrySetRegularCommunity", name, state, MakeResourceOptions(options, id))
        {
        }
