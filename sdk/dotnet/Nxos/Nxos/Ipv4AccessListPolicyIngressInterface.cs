...
{
    [NxosResourceType("nxos:nxos/ipv4AccessListPolicyIngressInterface:Ipv4AccessListPolicyIngressInterface")]
    public partial class Ipv4AccessListPolicyIngressInterface : global::Pulumi.CustomResource
    {
        ...
        public Ipv4AccessListPolicyIngressInterface(string name, Ipv4AccessListPolicyIngressInterfaceArgs args, CustomResourceOptions? options = null)
            : base("nxos:nxos/ipv4AccessListPolicyIngressInterface:Ipv4AccessListPolicyIngressInterface", name, args ?? new Ipv4AccessListPolicyIngressInterfaceArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private Ipv4AccessListPolicyIngressInterface(string name, Input<string> id, Ipv4AccessListPolicyIngressInterfaceState? state = null, CustomResourceOptions? options = null)
            : base("nxos:nxos/ipv4AccessListPolicyIngressInterface:Ipv4AccessListPolicyIngressInterface", name, state, MakeResourceOptions(options, id))
        {
        }
