...
{
    [NxosResourceType("nxos:nxos/vpcInstance:VpcInstance")]
    public partial class VpcInstance : global::Pulumi.CustomResource
    {
        ...
        public VpcInstance(string name, VpcInstanceArgs? args = null, CustomResourceOptions? options = null)
            : base("nxos:nxos/vpcInstance:VpcInstance", name, args ?? new VpcInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private VpcInstance(string name, Input<string> id, VpcInstanceState? state = null, CustomResourceOptions? options = null)
            : base("nxos:nxos/vpcInstance:VpcInstance", name, state, MakeResourceOptions(options, id))
        {
        }
