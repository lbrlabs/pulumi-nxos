...
namespace Lbrlabs.PulumiPackage.Nxos
{
    ...
    /// ```
    /// </summary>
    [NxosResourceType("nxos:index/vrfRouteTargetAddressFamily:VrfRouteTargetAddressFamily")]
    public partial class VrfRouteTargetAddressFamily : global::Pulumi.CustomResource
    {
        ...
        public VrfRouteTargetAddressFamily(string name, VrfRouteTargetAddressFamilyArgs args, CustomResourceOptions? options = null)
            : base("nxos:index/vrfRouteTargetAddressFamily:VrfRouteTargetAddressFamily", name, args ?? new VrfRouteTargetAddressFamilyArgs(), MakeResourceOptions(options, ""))
        {
        }
        ...
        private VrfRouteTargetAddressFamily(string name, Input<string> id, VrfRouteTargetAddressFamilyState? state = null, CustomResourceOptions? options = null)
            : base("nxos:index/vrfRouteTargetAddressFamily:VrfRouteTargetAddressFamily", name, state, MakeResourceOptions(options, id))
        {
        }
