 ...
 * ```
 */
export class FeaturePtp extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FeaturePtpState, opts?: pulumi.CustomResourceOptions): FeaturePtp {
        return new FeaturePtp(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'nxos:index/featurePtp:FeaturePtp';

    /**
     * Returns true if the given object is an instance of FeaturePtp.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FeaturePtp {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FeaturePtp.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: FeaturePtpArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FeaturePtpArgs | FeaturePtpState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FeaturePtpState | undefined;
            resourceInputs["adminState"] = state ? state.adminState : undefined;
            resourceInputs["device"] = state ? state.device : undefined;
        } else {
            const args = argsOrState as FeaturePtpArgs | undefined;
        ...
        super(FeaturePtp.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface FeaturePtpState {
    /**
     * Administrative state. - Choices: `enabled`, `disabled`
     */
 ...
 */
export interface FeaturePtpArgs {
    /**
     * Administrative state. - Choices: `enabled`, `disabled`
     */
    adminState: pulumi.Input<string>;
