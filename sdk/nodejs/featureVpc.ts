 ...
 * ```
 */
export class FeatureVpc extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: FeatureVpcState, opts?: pulumi.CustomResourceOptions): FeatureVpc {
        return new FeatureVpc(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'nxos:index/featureVpc:FeatureVpc';

    /**
     * Returns true if the given object is an instance of FeatureVpc.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is FeatureVpc {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === FeatureVpc.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: FeatureVpcArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: FeatureVpcArgs | FeatureVpcState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as FeatureVpcState | undefined;
            resourceInputs["adminState"] = state ? state.adminState : undefined;
            resourceInputs["device"] = state ? state.device : undefined;
        } else {
            const args = argsOrState as FeatureVpcArgs | undefined;
        ...
        super(FeatureVpc.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface FeatureVpcState {
    /**
     * Administrative state. - Choices: `enabled`, `disabled`
     */
 ...
 */
export interface FeatureVpcArgs {
    /**
     * Administrative state. - Choices: `enabled`, `disabled`
     */
    adminState: pulumi.Input<string>;
