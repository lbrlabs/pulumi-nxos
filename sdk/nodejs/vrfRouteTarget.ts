 ...
 * ```
 */
export class VrfRouteTarget extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VrfRouteTargetState, opts?: pulumi.CustomResourceOptions): VrfRouteTarget {
        return new VrfRouteTarget(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'nxos:index/vrfRouteTarget:VrfRouteTarget';

    /**
     * Returns true if the given object is an instance of VrfRouteTarget.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VrfRouteTarget {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VrfRouteTarget.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: VrfRouteTargetArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VrfRouteTargetArgs | VrfRouteTargetState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VrfRouteTargetState | undefined;
            ...
            const args = argsOrState as VrfRouteTargetArgs | undefined;
        ...
        super(VrfRouteTarget.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface VrfRouteTargetState {
    /**
     * Address family. - Choices: `ipv4-ucast`, `ipv6-ucast`
     */
 ...
 */
export interface VrfRouteTargetArgs {
    /**
     * Address family. - Choices: `ipv4-ucast`, `ipv6-ucast`
     */
    addressFamily: pulumi.Input<string>;
