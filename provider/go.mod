module github.com/lbrlabs/pulumi-nxos/provider

go 1.21.1

replace (
	github.com/CiscoDevNet/terraform-provider-nxos/shim => ./shim
...
require (
	github.com/CiscoDevNet/terraform-provider-nxos/shim v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/CiscoDevNet/terraform-provider-nxos v0.5.1 // indirect
	...
	github.com/netascode/go-nxos v0.3.0 // indirect
